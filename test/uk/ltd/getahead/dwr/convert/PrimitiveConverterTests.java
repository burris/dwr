...
public class PrimitiveConverterTests extends TestCase
{
    ...
    public void testConvertInbound() throws Exception
    {
        ...
        iv = new InboundVariable(ctx, null, "type", "2");
