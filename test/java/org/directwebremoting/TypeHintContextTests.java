...
public class TypeHintContextTests extends TestCase
{
    ...
    protected void setUp() throws Exception
    {
        ...
        ctx = new TypeHintContext(null, getClass().getMethod("testConstructor", new Class[0]), -1);
    }
    ...
    public void testToString() throws Exception
    {
        ...
        ctx = new TypeHintContext(null, getClass().getMethod("aComplexMethodSignature", new Class[] { String.class, Integer.class, Long.class }), -1);
        s = ctx.toString();
        assertNotNull(s);
    }
    ...
    public void testEquals() throws Exception
    {
        ...
        TypeHintContext ctx2 = new TypeHintContext(null, getClass().getMethod("testConstructor", new Class[0]), -1);
