 ...
 */
public class DefaultServerLoadMonitorTest extends TestCase
{
    public static void main(String[] args)
    {
        DefaultServerLoadMonitorTest test = new DefaultServerLoadMonitorTest();
        test.exec();
    }
     ...
     * The log stream
     */
    protected static final Log log = LogFactory.getLog(DefaultServerLoadMonitorTest.class);
