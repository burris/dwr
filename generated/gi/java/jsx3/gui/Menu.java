...
The following CDF attributes are supported by default:
  ...
  jsxid Ð the required CDF record id
  jsxtext Ð the text displayed in the menu option
  jsxtip Ð the tip displayed when the mouse hovers over the menu option
  jsximg Ð the optional image to display at the far left of the option
  jsxexecute Ð arbitrary JavaScript code to execute when the record is selected
  jsxkeycode Ð the optional key code to use as the hot key for the record. The format of this
         ...
         dynamic property.
  jsxdisabled Ð if "1" the option is disabled, the hot key is disabled and the option may not be
         selected with the mouse
  jsxdivider Ð if "1" a visual separator is rendered above the option
  jsxgroupname Ð if not empty, the option is grouped with other options with the same value for this
         attribute. Only one member of the group can be selected at one time.
  jsxselected Ð if "1" a the option is selected and check mark appears on the left side
  jsxstyle Ð additional CSS styles to apply to the option text
...
public class Menu extends jsx3.gui.Block
{
    ...
    public jsx3.gui.Menu disableItem(String strRecordId)
    {
        ...
        try
        {
            java.lang.reflect.Constructor<jsx3.gui.Menu> ctor = jsx3.gui.Menu.class.getConstructor(Context.class, String.class, ScriptProxy.class);
     ...
     */
    @SuppressWarnings("unchecked")
    public void isItemEnabled(String strRecordId, org.directwebremoting.proxy.Callback<Boolean> callback)
    {
     ...
     */
    @SuppressWarnings("unchecked")
    public void isItemSelected(String strRecordId, org.directwebremoting.proxy.Callback<Boolean> callback)
    {
        String key = org.directwebremoting.extend.CallbackHelper.saveCallback(callback, Boolean.class);
