...
public class DatePicker extends jsx3.gui.Block
{
     ...
     */
    public DatePicker(Context context, String extension, ScriptProxy scriptProxy)
    {
...
the displayed format will be localized accordingly.
     ...
     */
    @SuppressWarnings("unchecked")
    public void getDate(Callback<java.util.Date> callback)
    {
        String key = CallbackHelper.saveCallback(callback, java.util.Date.class);
