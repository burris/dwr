...
public class TextLine extends org.directwebremoting.proxy.jsx3.vector.Shape
{
    ...
    */
    ...
    public void setFontFamily(String fontFamily)
    {
        ScriptBuffer script = new ScriptBuffer();
        script.appendData(getProxyHelper().getContext())
              .appendScript("setFontFamily(")
              .appendData(fontFamily)
              .appendScript(");");
        getProxyHelper().getScriptProxy().addScript(script);
    }
    ...
    public void setFontStyle(String fontStyle)
    {
        ScriptBuffer script = new ScriptBuffer();
        script.appendData(getProxyHelper().getContext())
              .appendScript("setFontStyle(")
              .appendData(fontStyle)
              .appendScript(");");
        getProxyHelper().getScriptProxy().addScript(script);
    }
    ...
    public void setTextDecoration(String textDecoration)
    {
        ScriptBuffer script = new ScriptBuffer();
        script.appendData(getProxyHelper().getContext())
              .appendScript("setTextDecoration(")
              .appendData(textDecoration)
              .appendScript(");");
        getProxyHelper().getScriptProxy().addScript(script);
    }
