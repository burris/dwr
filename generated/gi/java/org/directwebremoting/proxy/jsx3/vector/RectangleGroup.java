 ...
 */
public class RectangleGroup extends org.directwebremoting.proxy.jsx3.vector.Shape
{
    /**
    ...
    public void addRelativeRectangle(int x1, int y1, int w, int h)
    {
        ScriptBuffer script = new ScriptBuffer();
        script.appendData(getProxyHelper().getContext())
              .appendScript("addRelativeRectangle(")
              .appendData(x1)
              .appendScript(",")
