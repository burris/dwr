...
TYPETEXTAREA.
     * @param OVERFLOW <code>OVERFLOWNORMAL</code>, <code>OVERFLOWAUTO</code>, or <code>OVERFLOWSCROLL</code>.
     * @return this object.
     */
    public org.directwebremoting.proxy.jsx3.gui.TextBox setOverflow(String OVERFLOW)
    {
        ScriptBuffer script = new ScriptBuffer();
        script.appendData(getProxyHelper().getContext())
    ...
    */
    ...
    public org.directwebremoting.proxy.jsx3.gui.TextBox setValidationType(String VALIDATIONTYPE)
    {
        ScriptBuffer script = new ScriptBuffer();
        script.appendData(getProxyHelper().getContext())
              .appendScript("setValidationType(")
              .appendData(VALIDATIONTYPE)
              .appendScript(");");
        getProxyHelper().getScriptProxy().addScript(script);
        return this;
    }
...
returned by the method, getValidationType; null is returned if the expression is not found
    ...
    */
    ...
    public org.directwebremoting.proxy.jsx3.gui.TextBox setValidationExpression(String strValidationExpression)
    {
        ScriptBuffer script = new ScriptBuffer();
        script.appendData(getProxyHelper().getContext())
              .appendScript("setValidationExpression(")
              .appendData(strValidationExpression)
              .appendScript(");");
        getProxyHelper().getScriptProxy().addScript(script);
        return this;
    }
