...
locale.
    ...
    */
    ...
    public void setSeconds(int intSeconds)
    {
        ScriptBuffer script = new ScriptBuffer();
        script.appendData(getProxyHelper().getContext())
              .appendScript("setSeconds(")
              .appendData(intSeconds)
              .appendScript(");");
        getProxyHelper().getScriptProxy().addScript(script);
    }
    ...
    */
    ...
    public void setMilliseconds(int intMillis)
    {
        ScriptBuffer script = new ScriptBuffer();
        script.appendData(getProxyHelper().getContext())
              .appendScript("setMilliseconds(")
              .appendData(intMillis)
              .appendScript(");");
        getProxyHelper().getScriptProxy().addScript(script);
    }
