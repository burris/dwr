...
public class Tab extends org.directwebremoting.proxy.jsx3.gui.Block
{
    ...
    public boolean onSetParent(boolean objParent, Callback callback)
    {
    ...
    */
    ...
    public org.directwebremoting.proxy.jsx3.gui.Tab setActiveColor(String strActiveColor)
    {
        ScriptBuffer script = new ScriptBuffer();
        script.appendData(getProxyHelper().getContext())
              .appendScript("setActiveColor(")
              .appendData(strActiveColor)
              .appendScript(");");
        getProxyHelper().getScriptProxy().addScript(script);
        return this;
    }
    ...
    */
    ...
    public org.directwebremoting.proxy.jsx3.gui.Tab setInactiveColor(String strInactiveColor)
    {
        ScriptBuffer script = new ScriptBuffer();
        script.appendData(getProxyHelper().getContext())
              .appendScript("setInactiveColor(")
              .appendData(strInactiveColor)
              .appendScript(");");
        getProxyHelper().getScriptProxy().addScript(script);
        return this;
    }
    ...
    */
     ...
     * @return 
     */
    public org.directwebremoting.proxy.jsx3.gui.Tab setText(String strText, boolean bRepaint)
    {
        ScriptBuffer script = new ScriptBuffer();
        script.appendData(getProxyHelper().getContext())
