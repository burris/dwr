...
public class StackGroup extends org.directwebremoting.proxy.jsx3.gui.LayoutGrid
{
    ...
    */
    ...
    public org.directwebremoting.proxy.jsx3.gui.StackGroup setBarSize(int intBarSize)
    {
        ...
        script.appendData(getProxyHelper().getContext())
              .appendScript("setBarSize(")
              .appendData(intBarSize)
              .appendScript(");");
    ...
    */
     ...
     * @return this object.
     */
    public org.directwebremoting.proxy.jsx3.gui.StackGroup setOrientation(int intOrientation)
    {
        ScriptBuffer script = new ScriptBuffer();
        script.appendData(getProxyHelper().getContext())
              .appendScript("setOrientation(")
              .appendData(intOrientation)
              .appendScript(");");
        getProxyHelper().getScriptProxy().addScript(script);
        return this;
    }
    ...
    */
    ...
    {
        ProxyHelper child = getProxyHelper().getChildHelper("setCols(\"" + strCols + "\", \"" + bRepaint + "\").");
        try
        {
            Constructor<org.directwebremoting.proxy.jsx3.gui.LayoutGrid> ctor = org.directwebremoting.proxy.jsx3.gui.LayoutGrid.class.getConstructor(ProxyHelper.class);
            return ctor.newInstance(child);
        }
        catch (Exception ex)
        {
            throw new IllegalArgumentException("Unsupported type: " + org.directwebremoting.proxy.jsx3.gui.LayoutGrid.class.getName());
        }
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public <T> T setCols(String strCols, boolean bRepaint, Class<T> returnType)
    {
        ProxyHelper child = getProxyHelper().getChildHelper("setCols(\"" + strCols + "\", \"" + bRepaint + "\").");
        try
        {
    ...
    {
        ProxyHelper child = getProxyHelper().getChildHelper("setRows(\"" + strRows + "\", \"" + bRepaint + "\").");
        try
        {
            Constructor<org.directwebremoting.proxy.jsx3.gui.LayoutGrid> ctor = org.directwebremoting.proxy.jsx3.gui.LayoutGrid.class.getConstructor(ProxyHelper.class);
            return ctor.newInstance(child);
     ...
     */
    @SuppressWarnings("unchecked")
    public <T> T setRows(String strRows, boolean bRepaint, Class<T> returnType)
    {
        ProxyHelper child = getProxyHelper().getChildHelper("setRows(\"" + strRows + "\", \"" + bRepaint + "\").");
        try
        {
