...
public class Splitter extends org.directwebremoting.proxy.jsx3.gui.Block
{
     ...
     * @param objJSXChild direct child whose generated VIEW will be directly inserted into the DOM to provide more efficient screen updates as repaint is costly for large applications
     * @param bGroup 
     * @return this object
     */
    @SuppressWarnings("unchecked")
    public org.directwebremoting.proxy.jsx3.gui.Splitter paintChild(org.directwebremoting.proxy.jsx3.app.Model objJSXChild, boolean bGroup)
    {
        ProxyHelper child = getProxyHelper().getChildHelper("paintChild(\"" + objJSXChild + "\", \"" + bGroup + "\").");
        try
        {
            Constructor<org.directwebremoting.proxy.jsx3.gui.Splitter> ctor = org.directwebremoting.proxy.jsx3.gui.Splitter.class.getConstructor(ProxyHelper.class);
            return ctor.newInstance(child);
        }
        catch (Exception ex)
        {
            throw new IllegalArgumentException("Unsupported type: " + org.directwebremoting.proxy.jsx3.gui.Splitter.class.getName());
        }
    }
    ...
    */
    ...
    public org.directwebremoting.proxy.jsx3.gui.Splitter setSubcontainer1Pct(String strSubcontainerPct, boolean bView)
    {
        ...
        script.appendData(getProxyHelper().getContext())
              .appendScript("setSubcontainer1Pct(")
              .appendData(strSubcontainerPct)
              .appendScript(",")
    ...
    */
    ...
    public org.directwebremoting.proxy.jsx3.gui.Splitter setSubcontainer1Min(int intMin)
    {
        ScriptBuffer script = new ScriptBuffer();
        script.appendData(getProxyHelper().getContext())
              .appendScript("setSubcontainer1Min(")
              .appendData(intMin)
              .appendScript(");");
        getProxyHelper().getScriptProxy().addScript(script);
        return this;
    ...
    */
    ...
    public org.directwebremoting.proxy.jsx3.gui.Splitter setSubcontainer2Min(int intMin)
    {
        ScriptBuffer script = new ScriptBuffer();
        script.appendData(getProxyHelper().getContext())
              .appendScript("setSubcontainer2Min(")
              .appendData(intMin)
              .appendScript(");");
        getProxyHelper().getScriptProxy().addScript(script);
        return this;
    ...
    */
    ...
    public org.directwebremoting.proxy.jsx3.gui.Splitter setOrientation(int ORIENTATION)
    {
        ScriptBuffer script = new ScriptBuffer();
        script.appendData(getProxyHelper().getContext())
              .appendScript("setOrientation(")
              .appendData(ORIENTATION)
              .appendScript(");");
        getProxyHelper().getScriptProxy().addScript(script);
        return this;
    }
