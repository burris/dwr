...
public class PieChart extends org.directwebremoting.proxy.jsx3.chart.RadialChart
{
    ...
    */
    ...
    public void setInnerRadius(float innerRadius)
    {
        ...
        script.appendData(getProxyHelper().getContext())
              .appendScript("setInnerRadius(")
              .appendData(innerRadius)
              .appendScript(");");
    ...
    */
    ...
    public void setSeriesPadding(float seriesPadding)
    {
        ScriptBuffer script = new ScriptBuffer();
        script.appendData(getProxyHelper().getContext())
              .appendScript("setSeriesPadding(")
              .appendData(seriesPadding)
              .appendScript(");");
        getProxyHelper().getScriptProxy().addScript(script);
    }
    ...
    */
    ...
    public void setTotalAngle(int totalAngle)
    {
        ScriptBuffer script = new ScriptBuffer();
        script.appendData(getProxyHelper().getContext())
              .appendScript("setTotalAngle(")
              .appendData(totalAngle)
              .appendScript(");");
        getProxyHelper().getScriptProxy().addScript(script);
    }
    ...
    */
    ...
    public void setStartAngle(int startAngle)
    {
        ScriptBuffer script = new ScriptBuffer();
        script.appendData(getProxyHelper().getContext())
              .appendScript("setStartAngle(")
              .appendData(startAngle)
              .appendScript(");");
        getProxyHelper().getScriptProxy().addScript(script);
    }
    ...
    */
    ...
    public void setSeriesStroke(String seriesStroke)
    {
        ScriptBuffer script = new ScriptBuffer();
        script.appendData(getProxyHelper().getContext())
              .appendScript("setSeriesStroke(")
              .appendData(seriesStroke)
              .appendScript(");");
        getProxyHelper().getScriptProxy().addScript(script);
    }
