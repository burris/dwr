...
public class GridLines extends org.directwebremoting.proxy.jsx3.chart.ChartComponent
{
    ...
    */
    ...
    public void setHorizontalAbove(boolean horizontalAbove)
    {
        ...
        script.appendData(getProxyHelper().getContext())
              .appendScript("setHorizontalAbove(")
              .appendData(horizontalAbove)
              .appendScript(");");
    ...
    */
    ...
    public void setInForeground(boolean inForeground)
    {
        ScriptBuffer script = new ScriptBuffer();
        script.appendData(getProxyHelper().getContext())
              .appendScript("setInForeground(")
              .appendData(inForeground)
              .appendScript(");");
        getProxyHelper().getScriptProxy().addScript(script);
    }
    ...
    */
    ...
    public void setBorderStroke(String borderStroke)
    {
        ScriptBuffer script = new ScriptBuffer();
        script.appendData(getProxyHelper().getContext())
              .appendScript("setBorderStroke(")
              .appendData(borderStroke)
              .appendScript(");");
        getProxyHelper().getScriptProxy().addScript(script);
    }
    ...
    */
    ...
    public void setStrokeMajorV(Object[] strokeMajorV)
    {
        ScriptBuffer script = new ScriptBuffer();
        script.appendData(getProxyHelper().getContext())
              .appendScript("setStrokeMajorV(")
              .appendData(strokeMajorV)
              .appendScript(");");
        getProxyHelper().getScriptProxy().addScript(script);
    }
    ...
    */
    ...
    public void setStrokeMinorV(Object[] strokeMinorV)
    {
        ScriptBuffer script = new ScriptBuffer();
        script.appendData(getProxyHelper().getContext())
              .appendScript("setStrokeMinorV(")
              .appendData(strokeMinorV)
              .appendScript(");");
        getProxyHelper().getScriptProxy().addScript(script);
    }
    ...
    */
    ...
    public void setStrokeMajorH(Object[] strokeMajorH)
    {
        ScriptBuffer script = new ScriptBuffer();
        script.appendData(getProxyHelper().getContext())
              .appendScript("setStrokeMajorH(")
              .appendData(strokeMajorH)
              .appendScript(");");
        getProxyHelper().getScriptProxy().addScript(script);
    }
    ...
    */
    ...
    public void setStrokeMinorH(Object[] strokeMinorH)
    {
        ScriptBuffer script = new ScriptBuffer();
        script.appendData(getProxyHelper().getContext())
              .appendScript("setStrokeMinorH(")
              .appendData(strokeMinorH)
              .appendScript(");");
        getProxyHelper().getScriptProxy().addScript(script);
    }
