...
public class Legend extends org.directwebremoting.proxy.jsx3.chart.ChartComponent
{
    ...
    */
    ...
    public void setBoxHeight(int boxHeight)
    {
        ...
        script.appendData(getProxyHelper().getContext())
              .appendScript("setBoxHeight(")
              .appendData(boxHeight)
              .appendScript(");");
    ...
    */
    ...
    public void setLineHeight(int lineHeight)
    {
        ScriptBuffer script = new ScriptBuffer();
        script.appendData(getProxyHelper().getContext())
              .appendScript("setLineHeight(")
              .appendData(lineHeight)
              .appendScript(");");
        getProxyHelper().getScriptProxy().addScript(script);
    }
    ...
    */
    ...
    public void setBackgroundFill(String backgroundFill)
    {
        ScriptBuffer script = new ScriptBuffer();
        script.appendData(getProxyHelper().getContext())
              .appendScript("setBackgroundFill(")
              .appendData(backgroundFill)
              .appendScript(");");
        getProxyHelper().getScriptProxy().addScript(script);
    }
    ...
    */
    ...
    public void setBackgroundStroke(String backgroundStroke)
    {
        ScriptBuffer script = new ScriptBuffer();
        script.appendData(getProxyHelper().getContext())
              .appendScript("setBackgroundStroke(")
              .appendData(backgroundStroke)
              .appendScript(");");
        getProxyHelper().getScriptProxy().addScript(script);
    }
    ...
    */
    ...
    public void setPreferredWidth(int preferredWidth)
    {
        ScriptBuffer script = new ScriptBuffer();
        script.appendData(getProxyHelper().getContext())
              .appendScript("setPreferredWidth(")
              .appendData(preferredWidth)
              .appendScript(");");
        getProxyHelper().getScriptProxy().addScript(script);
    }
    ...
    */
    ...
    public void setPreferredHeight(int preferredHeight)
    {
        ScriptBuffer script = new ScriptBuffer();
        script.appendData(getProxyHelper().getContext())
              .appendScript("setPreferredHeight(")
              .appendData(preferredHeight)
              .appendScript(");");
        getProxyHelper().getScriptProxy().addScript(script);
    }
