...
public class CategoryAxis extends org.directwebremoting.proxy.jsx3.chart.Axis
{
    ...
    */
    ...
    public void setTickAlignment(String tickAlignment)
    {
        ...
        script.appendData(getProxyHelper().getContext())
              .appendScript("setTickAlignment(")
              .appendData(tickAlignment)
              .appendScript(");");
    ...
    */
    ...
    public void setCategoryField(String categoryField)
    {
        ScriptBuffer script = new ScriptBuffer();
        script.appendData(getProxyHelper().getContext())
              .appendScript("setCategoryField(")
              .appendData(categoryField)
              .appendScript(");");
        getProxyHelper().getScriptProxy().addScript(script);
    }
    ...
    */
    ...
    public void setPaddingLow(float paddingLow)
    {
        ScriptBuffer script = new ScriptBuffer();
        script.appendData(getProxyHelper().getContext())
              .appendScript("setPaddingLow(")
              .appendData(paddingLow)
              .appendScript(");");
        getProxyHelper().getScriptProxy().addScript(script);
    }
    ...
    */
    ...
    public void setPaddingHigh(float paddingHigh)
    {
        ScriptBuffer script = new ScriptBuffer();
        script.appendData(getProxyHelper().getContext())
              .appendScript("setPaddingHigh(")
              .appendData(paddingHigh)
              .appendScript(");");
        getProxyHelper().getScriptProxy().addScript(script);
    }
