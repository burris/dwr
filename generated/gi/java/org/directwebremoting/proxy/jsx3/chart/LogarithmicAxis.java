...
public class LogarithmicAxis extends org.directwebremoting.proxy.jsx3.chart.Axis
{
    ...
    */
    ...
    public void setAutoAdjust(boolean autoAdjust)
    {
        ...
        script.appendData(getProxyHelper().getContext())
              .appendScript("setAutoAdjust(")
              .appendData(autoAdjust)
              .appendScript(");");
    ...
    */
    ...
    public void setBaseAtZero(boolean baseAtZero)
    {
        ScriptBuffer script = new ScriptBuffer();
        script.appendData(getProxyHelper().getContext())
              .appendScript("setBaseAtZero(")
              .appendData(baseAtZero)
              .appendScript(");");
        getProxyHelper().getScriptProxy().addScript(script);
    }
    ...
    */
    ...
    public void setShowNegativeValues(boolean showNegativeValues)
    {
        ScriptBuffer script = new ScriptBuffer();
        script.appendData(getProxyHelper().getContext())
              .appendScript("setShowNegativeValues(")
              .appendData(showNegativeValues)
              .appendScript(");");
        getProxyHelper().getScriptProxy().addScript(script);
    }
    ...
    */
    ...
    public void setMinExponent(int minExponent)
    {
        ScriptBuffer script = new ScriptBuffer();
        script.appendData(getProxyHelper().getContext())
              .appendScript("setMinExponent(")
              .appendData(minExponent)
              .appendScript(");");
        getProxyHelper().getScriptProxy().addScript(script);
    }
    ...
    */
    ...
    public void setMaxExponent(int maxExponent)
    {
        ScriptBuffer script = new ScriptBuffer();
        script.appendData(getProxyHelper().getContext())
              .appendScript("setMaxExponent(")
              .appendData(maxExponent)
              .appendScript(");");
        getProxyHelper().getScriptProxy().addScript(script);
    }
    ...
    */
    ...
    public void setMajorDivisions(int majorDivisions)
    {
        ScriptBuffer script = new ScriptBuffer();
        script.appendData(getProxyHelper().getContext())
              .appendScript("setMajorDivisions(")
              .appendData(majorDivisions)
              .appendScript(");");
        getProxyHelper().getScriptProxy().addScript(script);
    }
    ...
    */
    ...
    public void getCoordinateForNoClip(int value)
    {
        ScriptBuffer script = new ScriptBuffer();
        script.appendData(getProxyHelper().getContext())
              .appendScript("getCoordinateForNoClip(")
              .appendData(value)
              .appendScript(");");
        getProxyHelper().getScriptProxy().addScript(script);
    }
    ...
    */
    ...
    public void setAxisStroke(String axisStroke)
    {
        ScriptBuffer script = new ScriptBuffer();
        script.appendData(getProxyHelper().getContext())
              .appendScript("setAxisStroke(")
              .appendData(axisStroke)
              .appendScript(");");
        getProxyHelper().getScriptProxy().addScript(script);
    }
    ...
    public void setDisplayWidth(int displayWidth)
    {
        ScriptBuffer script = new ScriptBuffer();
        script.appendData(getProxyHelper().getContext())
              .appendScript("setDisplayWidth(")
              .appendData(displayWidth)
              .appendScript(");");
        getProxyHelper().getScriptProxy().addScript(script);
    }
    ...
    public void setHorizontal(boolean horizontal)
    {
        ScriptBuffer script = new ScriptBuffer();
        script.appendData(getProxyHelper().getContext())
              .appendScript("setHorizontal(")
              .appendData(horizontal)
              .appendScript(");");
        getProxyHelper().getScriptProxy().addScript(script);
    }
    ...
    public void setLabelClass(String labelClass)
    {
        ScriptBuffer script = new ScriptBuffer();
        script.appendData(getProxyHelper().getContext())
              .appendScript("setLabelClass(")
              .appendData(labelClass)
              .appendScript(");");
        getProxyHelper().getScriptProxy().addScript(script);
    }
    ...
    public void setLabelColor(String labelColor)
    {
        ScriptBuffer script = new ScriptBuffer();
        script.appendData(getProxyHelper().getContext())
              .appendScript("setLabelColor(")
              .appendData(labelColor)
              .appendScript(");");
        getProxyHelper().getScriptProxy().addScript(script);
    }
    ...
    public void setLabelFunction(String labelFunction)
    {
        ScriptBuffer script = new ScriptBuffer();
        script.appendData(getProxyHelper().getContext())
              .appendScript("setLabelFunction(")
              .appendData(labelFunction)
              .appendScript(");");
        getProxyHelper().getScriptProxy().addScript(script);
    }
    ...
    public void setLabelPlacement(String labelPlacement)
    {
        ScriptBuffer script = new ScriptBuffer();
        script.appendData(getProxyHelper().getContext())
              .appendScript("setLabelPlacement(")
              .appendData(labelPlacement)
              .appendScript(");");
        getProxyHelper().getScriptProxy().addScript(script);
    }
    ...
    public void setLabelStyle(String labelStyle)
    {
        ScriptBuffer script = new ScriptBuffer();
        script.appendData(getProxyHelper().getContext())
              .appendScript("setLabelStyle(")
              .appendData(labelStyle)
              .appendScript(");");
        getProxyHelper().getScriptProxy().addScript(script);
    }
    ...
    public void setMinorTickDivisions(int minorTickDivisions)
    {
        ScriptBuffer script = new ScriptBuffer();
        script.appendData(getProxyHelper().getContext())
              .appendScript("setMinorTickDivisions(")
              .appendData(minorTickDivisions)
              .appendScript(");");
        getProxyHelper().getScriptProxy().addScript(script);
    }
    ...
    public void setMinorTickLength(int minorTickLength)
    {
        ScriptBuffer script = new ScriptBuffer();
        script.appendData(getProxyHelper().getContext())
              .appendScript("setMinorTickLength(")
              .appendData(minorTickLength)
              .appendScript(");");
        getProxyHelper().getScriptProxy().addScript(script);
    }
    ...
    public void setMinorTickPlacement(String minorTickPlacement)
    {
        ScriptBuffer script = new ScriptBuffer();
        script.appendData(getProxyHelper().getContext())
              .appendScript("setMinorTickPlacement(")
              .appendData(minorTickPlacement)
              .appendScript(");");
        getProxyHelper().getScriptProxy().addScript(script);
    }
    ...
    public void setMinorTickStroke(String minorTickStroke)
    {
        ScriptBuffer script = new ScriptBuffer();
        script.appendData(getProxyHelper().getContext())
              .appendScript("setMinorTickStroke(")
              .appendData(minorTickStroke)
              .appendScript(");");
        getProxyHelper().getScriptProxy().addScript(script);
    }
    ...
    public void setShowLabels(boolean showLabels)
    {
        ScriptBuffer script = new ScriptBuffer();
        script.appendData(getProxyHelper().getContext())
              .appendScript("setShowLabels(")
              .appendData(showLabels)
              .appendScript(");");
        getProxyHelper().getScriptProxy().addScript(script);
    }
    ...
    public void setTickLength(int tickLength)
    {
        ScriptBuffer script = new ScriptBuffer();
        script.appendData(getProxyHelper().getContext())
              .appendScript("setTickLength(")
              .appendData(tickLength)
              .appendScript(");");
        getProxyHelper().getScriptProxy().addScript(script);
    }
    ...
    public void setTickPlacement(String tickPlacement)
    {
        ScriptBuffer script = new ScriptBuffer();
        script.appendData(getProxyHelper().getContext())
              .appendScript("setTickPlacement(")
              .appendData(tickPlacement)
              .appendScript(");");
        getProxyHelper().getScriptProxy().addScript(script);
    }
    ...
    public void setTickStroke(String tickStroke)
    {
        ScriptBuffer script = new ScriptBuffer();
        script.appendData(getProxyHelper().getContext())
              .appendScript("setTickStroke(")
              .appendData(tickStroke)
              .appendScript(");");
        getProxyHelper().getScriptProxy().addScript(script);
    }
