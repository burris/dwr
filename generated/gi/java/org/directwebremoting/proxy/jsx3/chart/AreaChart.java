 ...
 */
public class AreaChart extends org.directwebremoting.proxy.jsx3.chart.CartesianChart
{
    /**
     * All reverse ajax proxies need context to work from
     * @param helper The store of the context for the current action
     */
    public AreaChart(ProxyHelper helper)
    {
        super(helper);
    }
    ...
    */
     ...
     * @param series 
     */
    public void getYRange(Object series)
    {
        ScriptBuffer script = new ScriptBuffer();
        script.appendData(getProxyHelper().getContext()).appendScript("getYRange(").appendData(series).appendScript(");");
        getProxyHelper().getScriptProxy().addScript(script);
    }
     ...
     * @param series 
     */
    public void getXRange(Object series)
    {
        ScriptBuffer script = new ScriptBuffer();
        script.appendData(getProxyHelper().getContext()).appendScript("getXRange(").appendData(series).appendScript(");");
        getProxyHelper().getScriptProxy().addScript(script);
    }
