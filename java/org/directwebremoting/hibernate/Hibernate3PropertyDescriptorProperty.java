 ...
 */
public class Hibernate3PropertyDescriptorProperty extends PropertyDescriptorProperty
{
    /**
     * Simple constructor
     * @param descriptor The PropertyDescriptor that we are proxying to
     */
    public Hibernate3PropertyDescriptorProperty(PropertyDescriptor descriptor)
    {
        super(descriptor);
    }
