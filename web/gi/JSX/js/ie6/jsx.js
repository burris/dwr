...
nb=arguments.caller;nb!=null;nb=nb.caller){if(--Y>=0)continue;return nb.callee;}return null;};jsx3.lang.getStack=function(e){var
Bb=[];var
_=(e!=null?e:0)+1;for(var
yb=arguments.caller;yb!=null;yb=yb.caller){if(--_>=0)continue;Bb[Bb.length]=yb.callee;}return Bb;};if(window["jsx3"]==null)window["jsx3"]={};if(jsx3.lang==null)jsx3.lang={};jsx3.lang.yh=new
...
bc(""+j);};r.initErrorCapture=function(e){window.onerror=arguments.length>0?e:r.j9;};r.stopErrorCapture=function(q){window.onerror=null;};r.yB="thrown and not caught";r.j9=function(f,a,k){try{if(!r.NU&&jsx3.Class.forName("jsx3.util.Logger")!=null&&jsx3.util.Logger.GLOBAL!=null){if(f.indexOf(r.yB)>=0)if(bc.gm!=null){var
...
B=0;B<this.HM.length;B++)if(m==this.HM[B].getName())return this.HM[B];return null;};k.getStaticFieldNames=function(){return this.xF.concat();};k.toString=function(){return this.AX;};});jsx3.Package.definePackage("jsx3",function(){jsx3.ADDINSPATH="JSX/addins/";jsx3.XMLREGKEY="Msxml2.FreeThreadedDOMDocument.3.0";jsx3.XSLREGKEY="Msxml2.XSLTemplate.3.0";jsx3.HTTPREGKEY="Msxml2.XMLHTTP.3.0";jsx3.wC=null;jsx3.getXmlVersion=function(){if(this.wC==null){var
D=jsx3.getEnv("jsxxmlversion");if(D){jsx3.wC=D;}else if(jsx3.getEnv("jsxxmlregkey")||jsx3.getEnv("jsxxslregkey")){jsx3.wC=3;}else try{new
ActiveXObject("MSXML2.FreeThreadedDOMDocument.4.0");jsx3.wC=4;}catch(t){try{new
ActiveXObject("MSXML2.FreeThreadedDOMDocument.3.0");jsx3.wC=3;}catch(db){throw new
jsx3.Exception("Can not instantiate Microsoft XML control version 3 or 4.");}}}return this.wC;};jsx3.getXmlInstance=function(){var
vc=jsx3.getEnv("jsxxmlregkey")||"MSXML2.FreeThreadedDOMDocument."+this.getXmlVersion()+".0";return new
ActiveXObject(vc);};jsx3.getXslInstance=function(){var
Ec=jsx3.getEnv("jsxxslregkey")||"MSXML2.XSLTemplate."+this.getXmlVersion()+".0";return new
ActiveXObject(Ec);};jsx3.getHttpInstance=function(){var
lb=jsx3.getEnv("jsxhttpregkey")||"MSXML2.XMLHTTP."+this.getXmlVersion()+".0";return new
ActiveXObject(lb);};jsx3.DESERIALIZE="JSX30DESERIALIZE";jsx3.INITIALIZE="JSX30INITIALIZE";jsx3.STARTUP_EVENT=null;jsx3.CACHE=null;jsx3.EVENT=null;jsx3.getSharedCache=function(){if(jsx3.CACHE==null)jsx3.CACHE=new
jsx3.app.Cache();return jsx3.CACHE;};jsx3.getSystemCache=function(){if(jsx3.kB==null)jsx3.kB=new
jsx3.app.Cache();return jsx3.kB;};jsx3.eval=function(e,b){if(e!=null&&e!==""){var
yc="";if(b){var
_ec=b;var
cc=[];for(var mb in _ec)cc[cc.length]="var "+mb+" = _ec."+mb+";";yc=cc.join("");}return eval(yc+e);}};jsx3.resolveURI=function(h){return jsx3.net.URIResolver.DEFAULT.resolveURI(h).toString();};jsx3.makeCallback=function(i,l,f){var
R=[];for(var
wc=2;wc<arguments.length;wc++)R[R.length]=arguments[wc];return function(){R[R.length]=arguments;i.apply(l,R);};};jsx3.clone=function(i){if(typeof i!="object")return i;var
K={};for(var S in i)K[S]=i[S];return K;};jsx3.LV={};jsx3.LV["jsx3.gui.MatrixColumn"]="jsx3.gui.Matrix.Column";jsx3.require=function(f){for(var
V=0;V<arguments.length;V++){var
C=arguments[V];C=jsx3.LV[C]||C;if(jsx3.Class.forName(C)==null)jsx3.CLASS_LOADER.loadClass(C);}};jsx3.rU=[];jsx3.XG=[];jsx3.oE=null;jsx3.sleep=function(f,d,k,e){if(d&&jsx3.XG[d])if(e)jsx3.XG[d][0]=null;else return;var
S=[f,d,k];var
Gc=jsx3.rU;Gc[Gc.length]=S;jsx3.XG[d]=S;if(jsx3.oE==null)jsx3.oE=window.setTimeout(jsx3.ow,0);};jsx3.QUEUE_DONE="queueDone";jsx3.ow=function(){var
...
Gb=0;Gb<qb.length;Gb++)jsx3.gui.Event.unsubscribeAll(jsx3.gui.Event[qb[Gb]]);}jsx3.NativeError.stopErrorCapture();var
kc=document.getElementsByTagName("script");for(var
Gb=0;Gb<kc.length;Gb++){var
C=kc.item(Gb);C.parentNode.removeChild(C);}if(window!=window.top||window.event.clientX<-1*window.screen.width&&window.event.clientY<-1*window.screen.height){}else{}jsx3.CLASS_LOADER.destroy();window.jsx3=null;};jsx3.getClass=function(d){try{var
cc=eval(d);return typeof cc=="function"?cc:null;}catch(Kc){return null;}};jsx3._e=function(l){try{var
Db=eval(l+".prototype");return typeof Db=="object"&&typeof Db.constructor=="function"?Db:null;}catch(Kc){return null;}};jsx3.getClassConstants=function(o){var
Ac=jsx3.getClass(o);if(Ac!=null){var
qb=[];for(var yb in Ac)if(yb.toUpperCase()==yb)qb[qb.length]=o+"."+yb;return qb;}};jsx3.getInstanceMethods=function(j){var
xb=jsx3._e(j);var
gc=[];for(var Ib in xb)if(typeof xb[Ib]=="function"){var
D=xb[Ib].toString();gc[gc.length]=D.substring(9,D.indexOf(")")+1);}return gc;};jsx3.getClassMethods=function(b){var
Sb=jsx3.getClass(b);var
Nb="";for(var ub in Sb)if(typeof Sb[ub]=="function"){var
Y=Sb[ub].toString();Nb=Nb+(ub+Y.substring(8,Y.indexOf(")")+1)+"\n");}return Nb;};jsx3.doInherit=function(b,j,s){var
zb=jsx3.getClass(b);var
ec=jsx3.getClass(j);if(ec==null){jsx3.util.Logger.doLog("INHR01","Super class '"+j+"' of '"+b+"' not properly defined",1,false);return;}if(zb.isInherited==null||s!=null&&s){if(!s){zb.SUPER=j;zb.SUPERS={};for(var Ic in ec.SUPERS){zb.SUPERS[Ic]=ec.SUPERS[Ic];zb.SUPERS[b]=1;}}zb.className=b;if(zb.INHERITANCE==null)zb.INHERITANCE=[b];if(ec.INHERITANCE)for(var
R=ec.INHERITANCE.length-1;R>=0;R--)zb.INHERITANCE.splice(1,0,ec.INHERITANCE[R]);else zb.INHERITANCE.splice(1,0,j);if(zb.INTERFACES==null)zb.INTERFACES={};if(ec.INTERFACES){for(var Ic in ec.INTERFACES)zb.INTERFACES[Ic]=ec.INTERFACES[Ic];}else zb.INTERFACES[j]="1";zb.INTERFACES[b]="1";if(!(s!=null&&s))zb.isInherited=true;var
Lb=jsx3._e(j);var
Ub=jsx3._e(b);for(var Ic in Lb)if(typeof Ub[Ic]!="function")Ub[Ic]=Lb[Ic];}};jsx3.doImplement=function(p,e){jsx3.doInherit(p,e,true);};jsx3.doMixin=function(l,f){var
wc=jsx3._e(f);for(var F in wc)if(typeof wc[F]=="function")l[F]=wc[F];};jsx3.doDefine=function(i,p){var
Gc=jsx3.getClass(i);if(Gc.isDefined==null){Gc.isDefined=true;p();}};jsx3.out=function(s,a,l,m){if(jsx3.Class.forName("jsx3.util.Logger"))jsx3.util.Logger.doLog(s,a,l,m);};window.doInherit=jsx3.doInherit;window.doImplement=jsx3.doImplement;window.doMixin=jsx3.doMixin;window.doDefine=jsx3.doDefine;jsx3.log=function(h){if(jsx3.Class.forName("jsx3.util.Logger")&&jsx3.util.Logger.GLOBAL){if(jsx3.GQ){for(var
Wb=0;Wb<jsx3.GQ.length;Wb++)jsx3.util.Logger.GLOBAL.info(jsx3.GQ[Wb]);delete jsx3.GQ;}jsx3.util.Logger.GLOBAL.info(h);}else{var
wc=jsx3.GQ;if(!wc)jsx3.GQ=wc=[];wc[wc.length]=h;}};});jsx3.Package.definePackage("jsx3.app",function(){});jsx3.Boolean={};jsx3.Boolean.TRUE=1;jsx3.Boolean.FALSE=0;jsx3.Boolean.valueOf=function(h){return h?1:0;};jsx3.Package.definePackage("jsx3.gui",function(f){f.po=function(k,g){var
vb=[];for(var
G=0;G<arguments.length-1;G=G+2){k=arguments[G];if(k._jsxRs)continue;k._jsxRs=true;g=arguments[G+1];var
hc={};for(var O in g)hc[O]=O=="className"?k.className:k.style[O];vb.push(k,hc,g);}f.bv(vb,0,6);};f.bv=function(p,s,b){if(s==b){for(var
db=0;db<p.length-2;db=db+3){var
Tb=p[db];Tb._jsxRs=null;}return;}for(var
db=0;db<p.length-2;db=db+3){var
Tb=p[db];var
Bb=s%2==0?p[db+2]:p[db+1];for(var J in Bb)if(J=="className")Tb.className=Bb[J];else Tb.style[J]=Bb[J];}window.setTimeout(function(){f.bv(p,s+1,b);},75);};f.isMouseEventModKey=function(k){if(jsx3.app.Browser.macosx)return k.metaKey();else return k.ctrlKey();};});jsx3.Package.definePackage("jsx3.lang",function(n){});jsx3.Package.definePackage("jsx3.net",function(o){});jsx3.Class.defineInterface("jsx3.net.URIResolver",null,function(h,k){h.lF=function(){if(this.V1==null)this.V1=new
jsx3.net.URI(jsx3.getEnv("jsxabspath"));return this.V1;};h.Gy=function(){var
D=jsx3.getEnv("jsxhomepath");if(D==null)return new
jsx3.net.URI(jsx3.getEnv("jsxscriptapppath"));if(this.vs==null)this.vs=new
jsx3.net.URI(D);return this.vs;};h.DEFAULT=h.jsxclass.newInnerClass();h.DEFAULT.resolveURI=function(n){var
qc=jsx3.net.URI.valueOf(n);var
gb=qc.getScheme();var
G=qc.getPath();var
tc=null;if(gb){var
U=jsx3.net.URI.fromParts(null,null,null,null,G,qc.getQuery(),qc.getFragment());if(gb=="jsx"){tc=h.lF().resolve("JSX"+U);}else if(gb=="jsxapp"){var
Qb=h.getResolver(qc);tc=Qb.resolveURI(U.toString().substring(1));}else if(gb=="jsxaddin"){var
kb=qc.getHost();var
M=kb.split("!",2).join(":");var
Jc=jsx3.System.getLoadedAddinByKey(M);tc=Jc!=null?Jc.resolveURI(U.toString().substring(1)):qc;}else if(gb=="jsxuser"){tc=h.Gy().resolve(U.toString().substring(1));}else tc=qc;}else if(G.indexOf("JSX"+"/")==0){tc=h.lF().resolve(qc);}else if(G.indexOf("JSXAPPS"+"/")==0){tc=h.Gy().resolve(qc);}else if(G.indexOf("/")==0){tc=qc;}else if(G.indexOf("GI_Builder/")==0){tc=h.lF().resolve(qc);}else if(G.indexOf("..")>=0){var
Fb=jsx3.app.Browser.getLocation();tc=Fb.relativize(Fb.resolve(qc));}else tc=qc;return tc;};h.DEFAULT.getUriPrefix=function(){return h.lF().toString();};h.DEFAULT.relativizeURI=function(m,a){return jsx3.net.URI.valueOf(m);};h.JSX=h.jsxclass.newInnerClass();h.JSX.getURI=function(){if(this._uri==null)this._uri=h.lF().resolve("JSX"+"/");return this._uri;};h.JSX.resolveURI=function(c){var
jc=jsx3.net.URI.valueOf(c);if(!h.isAbsoluteURI(jc)){return h.DEFAULT.resolveURI(this.getURI().resolve(jc.toString()));}else return h.DEFAULT.resolveURI(jc);};h.JSX.getUriPrefix=function(){return h.lF()+"JSX"+"/";};h.JSX.relativizeURI=function(l,s){var
Bb=this.getURI().relativize(l);if(Bb.isAbsolute()||s)return Bb;else return jsx3.net.URI.fromParts("jsx",null,null,null,"/"+Bb.getPath(),Bb.getQuery(),Bb.getFragment());};h.USER=h.jsxclass.newInnerClass();h.USER.resolveURI=function(o){var
x=jsx3.net.URI.valueOf(o);if(!h.isAbsoluteURI(x)){return h.DEFAULT.resolveURI(h.Gy().resolve(x));}else return h.DEFAULT.resolveURI(x);};h.USER.getUriPrefix=function(){return h.Gy().toString();};h.USER.relativizeURI=function(n,b){var
zb=h.Gy().relativize(n);if(zb.isAbsolute()||b)return zb;else return jsx3.net.URI.fromParts("jsxuser",null,null,null,"/"+zb.getPath(),zb.getQuery(),zb.getFragment());};h.isAbsoluteURI=function(s){var
Hc=jsx3.net.URI.valueOf(s);if(Hc.getScheme()!=null)return true;var
zb=Hc.getPath();return zb.indexOf("/")==0||zb.indexOf("JSX"+"/")==0||zb.indexOf("JSXAPPS"+"/")==0||zb.indexOf("GI_Builder/")==0;};h.getResolver=function(n){var
ab=jsx3.net.URI.valueOf(n);var
Dc=ab.getScheme();if(Dc)if(Dc=="jsx"){return h.JSX;}else if(Dc=="jsxapp"){var
bb=ab.getHost().replace(/!/g,"/");var
zc=jsx3.System.getLoadedAppByPath(bb);return zc!=null?zc:new
jsx3.net.ServerURIResolver(bb);}else if(Dc=="jsxaddin"){var
S=ab.getHost();var
x=S.split("!",2).join(":");return jsx3.System.getLoadedAddinByKey(x);}else if(Dc=="jsxuser")return h.USER;return h.DEFAULT;};k.resolveURI=jsx3.Method.newAbstract("strURI");k.getUriPrefix=jsx3.Method.newAbstract();k.relativizeURI=jsx3.Method.newAbstract("strURI","bRel");});jsx3.Class.defineClass("jsx3.net.ServerURIResolver",null,[jsx3.net.URIResolver],function(e,c){var
jb=jsx3.net.URIResolver;c.init=function(p){this._host=p;this._uri=new
jsx3.net.URI(jsx3.getEnv("jsxhomepath")+"JSXAPPS"+"/"+p.replace(/!/g,"/")+"/");};c.resolveURI=function(h){var
B=jsx3.net.URI.valueOf(h);if(!jb.isAbsoluteURI(B)){return jb.DEFAULT.resolveURI(this._uri.resolve(B.toString()));}else return jb.DEFAULT.resolveURI(B);};c.getUriPrefix=function(){return this._uri.toString();};c.relativizeURI=function(f,m){var
M=this._uri.relativize(f);if(M.isAbsolute()||m)return M;else return jsx3.net.URI.fromParts("jsxapp",null,this._host,null,"/"+M.getPath(),M.getQuery(),M.getFragment());};c.toString=function(){return this._uri.toString();};});jsx3.Package.definePackage("jsx3.xml",function(h){});jsx3.Package.definePackage("jsx3.util",function(c){c.compareVersions=function(k,j){var
wc=k.split(/\./);var
W=j.split(/\./);var
...
T=k.ND[Ic];if(bc[kc]!=k.q3){if(J!=null&&J.isLoggable(5))J.debug("setting event handler "+kc+" on "+bc+".");if(bc[kc]!=null)T[kc]=bc[kc];bc[kc]=k.q3;}}}catch(Kc){if(J!=null&&J.isLoggable(5))J.debug("error subscribing to event "+d,jsx3.NativeError.wrap(Kc));k._deregisterWindow(sb);Ic--;}};k.subscribeLoseFocus=function(f,p,l){this.subscribe("focusin",f,function(r){var
O=r.event.srcElement();while(O!=null){if(O==p)return;O=O.parentNode;}if(typeof l=="function")l.call(f,r);else f[l](r);});};k.unsubscribeLoseFocus=function(m){this.unsubscribe("focusin",m);};k.preventSelection=function(q){q.selection.createRange();};k.unsubscribe=function(s,j){var
xc=k.t0();if(xc!=null&&xc.isLoggable(5))xc.debug("Unsubscribing from event "+s+": "+j.toString().substring(0,50).replace(/\s+/g," "));k.wQ.unsubscribe(s,j);if(k.wQ.getSubscriberCount(s)==0)k.bz(s);};k.unsubscribeAll=function(r){var
z=k.t0();if(z!=null&&z.isLoggable(5))z.debug("Unsubscribing all from event "+r+".");k.wQ.unsubscribeAll(r);k.bz(r);};k.publish=function(r){var
tc={subject:r.getType(),target:k,event:r};k.T3(tc);};k.T3=function(o){var
rc="on"+o.subject.toLowerCase();var
Nb=k.t0();if(Nb!=null&&Nb.isLoggable(6))Nb.trace("Publishing event: "+rc+".");var
Fb=k.ND[0];if(Fb[rc]!=null)Fb[rc]();k.wQ.publish(o);};k.q3=function(e){var
Eb=new
k(e!=null?e:window.event);var
sb=k.t0();if(sb!=null&&sb.isLoggable(6))sb.trace("Handling event: "+Eb.getType()+".");var
K={subject:Eb.getType(),target:k,event:Eb};k.T3(K);if(K.returnValue)return K.returnValue;};k.bz=function(h){var
Ec="on"+h;var
mc=k.t0();for(var
Cb=0;Cb<k.cy.length;Cb++)try{var
hc=k.cy[Cb];var
kb=k.gH(hc,h);if(kb.attachEvent&&k.cX(h)){var
Mc=k.LT[Cb];if(Mc[h]){if(mc!=null&&mc.isLoggable(5))mc.debug("detaching event listener "+h+" from "+kb);kb.detachEvent(Ec,k.q3);Mc[h]=false;}}else if(kb.removeEventListener&&k.l2(h)){var
Mc=k.LT[Cb];if(Mc[h]){if(mc!=null&&mc.isLoggable(5))mc.debug("removing event listener "+h+" from "+kb+".");kb.removeEventListener(h,k.q3,false);Mc[h]=false;}}else{var
ec=k.ND[Cb];if(mc!=null&&mc.isLoggable(5))mc.debug("unsetting event handler "+Ec+" on "+kb+".");if(ec[Ec]!=null){kb[Ec]=ec[Ec];delete ec[Ec];}else kb[Ec]=null;}}catch(Kc){if(mc!=null&&mc.isLoggable(5))mc.debug("error subscribing to event "+h,jsx3.NativeError.wrap(Kc));k._deregisterWindow(hc);Cb--;}};k.gH=function(s,r){return r=="beforeunload"||r=="unload"||r=="resize"?s:s.document;};k.cX=function(c){return c!="beforeunload";};k.l2=function(m){return m!="beforeunload";};a.init=function(m,g){this.SL=m;if(g)this._clone=jsx3.clone(m);};a.bg=function(){if(this._clone==null)this._clone=jsx3.clone(this.SL);this._clone._jsxEt=true;};k.wrap=function(p,o){return p instanceof k?p:new
k(p,o);};k.getCurrent=function(m){return window.event?new
k(window.event,m):null;};a.Hx=function(){try{if(this.SL==null)return this._clone;else if(typeof this.SL.type=="string")return this.SL;}catch(Kc){}this.SL=null;return this._clone;};a.event=function(){return this.Hx();};a.getType=function(){return this.Hx().type;};a.srcElement=function(){var
N=this.Hx();return N.target||N.srcElement;};a.toElement=function(){var
U=this.Hx();return U.toElement;};a.fromElement=function(){var
Ac=this.Hx();return Ac.fromElement;};a.isMouseEvent=function(){var
Ob=this.getType()||"";return Ob.indexOf("mouse")==0||Ob=="click"||Ob=="dblclick";};a.isKeyEvent=function(){return (this.getType()||"").indexOf("key")==0;};a.setCapture=function(s){s.setCapture();};a.releaseCapture=function(m){m.releaseCapture();};a.keyCode=function(){var
uc=this.Hx();return uc.keyCode;};a.clientX=function(){var
E=this.Hx();return E?E.clientX:Number.NaN;};a.clientY=function(){var
cb=this.Hx();return cb?cb.clientY:Number.NaN;};a.getOffsetX=function(){return this.Hx().offsetX-this.Hx().srcElement.scrollLeft;};a.getOffsetY=function(){return this.Hx().offsetY-this.Hx().srcElement.scrollTop;};a.getScreenX=function(){return this.Hx().screenX;};a.getScreenY=function(){return this.Hx().screenY;};a.getTrueX=function(){return this.Hx().clientX;};a.getTrueY=function(){return this.Hx().clientY;};a.getWheelDelta=function(){var
J=this.Hx().wheelDelta;var
V=J>0?Math.ceil(J/120):Math.floor(J/120);return V;};a.shiftKey=function(){var
rc=this.Hx();return rc.shiftKey;};a.ctrlKey=function(){var
sb=this.Hx();return sb.ctrlKey;};a.altKey=function(){var
Vb=this.Hx();return Vb.altKey;};a.metaKey=function(){return false;};a.enterKey=function(){return this.Hx().keyCode==13;};a.spaceKey=function(){return this.Hx().keyCode==32;};a.tabKey=function(){return this.Hx().keyCode==9;};a.rightArrow=function(){return this.Hx().keyCode==39;};a.leftArrow=function(){return this.Hx().keyCode==37;};a.upArrow=function(){return this.Hx().keyCode==38;};a.downArrow=function(){return this.Hx().keyCode==40;};a.deleteKey=function(){return this.Hx().keyCode==46;};a.backspaceKey=function(){return this.Hx().keyCode==8;};a.insertKey=function(){return this.Hx().keyCode==45;};a.homeKey=function(){return this.Hx().keyCode==36;};a.endKey=function(){return this.Hx().keyCode==35;};a.pageUpKey=function(){return this.Hx().keyCode==33;};a.pageDownKey=function(){return this.Hx().keyCode==34;};a.escapeKey=function(){return this.Hx().keyCode==27;};a.exists=function(){return this.Hx()!=null;};a.cancelBubble=function(){var
hb=this.Hx();hb.cancelBubble=true;};a.cancelReturn=function(){this.Hx().returnValue=false;};a.cancelKey=function(){var
t=this.Hx();t.keyCode=0;t.returnValue=false;};a.cancelAll=function(){this.cancelBubble();this.cancelKey();this.cancelReturn();};a.leftButton=function(){var
gc=this.Hx();if(jsx3.app.Browser.macosx&&gc.ctrlKey)return false;var
_b=this.getType();if(_b=="mousedown"||_b=="mouseup"){return gc.button==1;}else if(_b=="click"||_b=="dblclick")return gc.button==0;return false;};a.rightButton=function(){var
sc=this.Hx();var
qb=this.getType();if(qb=="mousedown"||qb=="mouseup")return sc.button==2||jsx3.app.Browser.macosx&&sc.ctrlKey;else return false;};a.button=function(){var
Gc=this.Hx();return Gc.button;};a.setReturn=function(f){this.Hx().returnValue=f;};a.setKeyCode=function(j){this.Hx().keyCode=j;};a.isModifierKey=function(){var
wc=this.Hx();return wc.keyCode==16||wc.keyCode==17||wc.keyCode==18||wc.keyCode==-1;};a.hasModifier=function(b){return !b&&this.shiftKey()||this.ctrlKey()||this.altKey()||this.metaKey();};a.isArrowKey=function(){var
jc=this.keyCode();return jc>=37&&jc<=40;};a.isFunctionKey=function(){var
qc=this.keyCode();return qc>=112&&qc<=126;};a.getAttribute=function(n){return k.yQ!=null?k.yQ[n]:null;};a.setAttribute=function(q,i){if(k.yQ==null){k.yQ={};jsx3.sleep(function(){delete k.yQ;},"jsx3.gui.Event.setAttribute");}k.yQ[q]=i;};a.removeAttribute=function(i){if(k.yQ!=null)delete k.yQ[i];};k.dispatchMouseEvent=function(s,p,j){var
bc=s.ownerDocument.createEventObject();if(j)for(var ob in j)bc[ob]=j[ob];s.fireEvent("on"+p,bc);};k.dispatchKeyEvent=function(m,j,l,i,p,h,d){var
J=m.ownerDocument.createEventObject();if(d)for(var Kc in d)J[Kc]=d[Kc];J.keyCode=l;J.shiftKey=J.shiftLeft=i;J.ctrlKey=p;J.altKey=h;m.fireEvent("on"+j,J);};a.isFakeOut=function(m){if(this.getType()=="mouseout"){var
T=this.toElement();try{while(T!=null){if(T==m)return true;T=T.parentNode;}}catch(Kc){return false;}}return false;};a.isFakeOver=function(j){if(this.getType()=="mouseover"){var
Jb=this.fromElement();try{while(Jb!=null){if(Jb==j)return true;Jb=Jb.parentNode;}}catch(Kc){return false;}}return false;};a.toString=function(){var
Bc=this.Hx();if(Bc==null)return "@jsx3.gui.Event <empty>";var
L=[];for(var ob in Bc)if(typeof Bc[ob]!="function")L[L.length]=ob;L.sort();var
nb=["@jsx3.gui.Event "];for(var
u=0;u<L.length;u++)nb[nb.length]=L[u]+":"+Bc[L[u]]+" ";return nb.join("");};});jsx3.gui.Event.subscribe("unload",jsx3.destroy);jsx3.Class.defineClass("jsx3.EVT",null,[jsx3.util.EventDispatcher],function(e,h){h.init=function(m){if(m)this.e=jsx3.clone(m);};h.handleEvent=function(p,l){var
pb=jsx3.gui.Event.getCurrent();if(pb==null){jsx3.util.Logger.getLogger(e.jsxclass.getName()).warn("handleEvent called when current event null: "+p);return;}if(pb.getType()!=p.substring(2))jsx3.util.Logger.getLogger(e.jsxclass.getName()).warn("handleEvent called for type that does not match the current event's type: "+pb.getType()+" "+p);jsx3.gui.Event.publish(pb);};h.registerEvent=function(j,k){if(j.indexOf("on")==0)j=j.substring(2);jsx3.gui.Event.subscribe(j,function(){jsx3.eval(k);});};h.event=function(){return this.e||window.event;};h.Hx=function(){return this.e||window.event;};h.srcElement=function(){var
nc=this.Hx();return nc&&nc.srcElement;};h.toElement=function(){var
fb=this.Hx();return fb&&fb.toElement;};h.fromElement=function(){var
Xb=this.Hx();return Xb&&Xb.fromElement;};h.keyCode=function(){var
t=this.Hx();return t&&t.keyCode;};h.clientX=function(){var
Gb=this.Hx();return Gb?Gb.clientX:Number.NaN;};h.clientY=function(){var
Cb=this.Hx();return Cb?Cb.clientY:Number.NaN;};h.getTrueX=function(){return this.Hx().screenX-window.screenLeft;};h.getTrueY=function(){return this.Hx().screenY-window.screenTop;};h.shiftKey=function(){var
Fb=this.Hx();return Fb&&Fb.shiftKey;};h.ctrlKey=function(){var
K=this.Hx();return K&&K.ctrlKey;};h.altKey=function(){var
ob=this.Hx();return ob&&ob.altKey;};h.enterKey=function(){return this.Hx().keyCode==13;};h.spaceKey=function(){return this.Hx().keyCode==32;};h.tabKey=function(){return this.Hx().keyCode==9;};h.rightArrow=function(){return this.Hx().keyCode==39;};h.leftArrow=function(){return this.Hx().keyCode==37;};h.upArrow=function(){return this.Hx().keyCode==38;};h.downArrow=function(){return this.Hx().keyCode==40;};h.deleteKey=function(){return this.Hx().keyCode==46;};h.backspaceKey=function(){return this.Hx().keyCode==8;};h.insertKey=function(){return this.Hx().keyCode==45;};h.homeKey=function(){return this.Hx().keyCode==36;};h.endKey=function(){return this.Hx().keyCode==35;};h.pageUpKey=function(){return this.Hx().keyCode==33;};h.pageDownKey=function(){return this.Hx().keyCode==34;};h.escapeKey=function(){return this.Hx().keyCode==27;};h.exists=function(){return this.Hx()!=null;};h.cancelBubble=function(){this.Hx().cancelBubble=true;};h.cancelReturn=function(){this.Hx().returnValue=false;};h.cancelKey=function(){this.Hx().keyCode=0;};h.leftButton=function(){var
Qb=this.Hx();return Qb&&Qb.button==0;};h.rightButton=function(){var
x=this.Hx();return x&&x.button==2;};h.button=function(){var
sc=this.Hx();return sc?sc.button:null;};h.setReturn=function(s){this.Hx().returnValue=s;};h.setKeyCode=function(j){this.Hx().keyCode=j;};h.isModifierKey=function(){var
_b=this.Hx();return _b.keyCode==16||_b.keyCode==17||_b.keyCode==18;};h.toString=function(){var
R="";var
Nb=this.Hx();if(Nb==null)return "jsx3.EVT <empty>";var
F=[];for(var zc in Nb)F.push(zc);F.sort();for(var
Ob=0;Ob<F.length;Ob++)R=R+(F[Ob]+":"+Nb[F[Ob]]+" ");return R;};});jsx3.EVENT=new
jsx3.EVT();jsx3.EVENT.MOUSEOVER="onmouseover";jsx3.EVENT.MOUSEOUT="onmouseout";jsx3.EVENT.MOUSEDOWN="onmousedown";jsx3.EVENT.MOUSEUP="onmouseup";jsx3.EVENT.MOUSEMOVE="onmousemove";jsx3.EVENT.CLICK="onclick";jsx3.EVENT.DOUBLECLICK="ondblclick";jsx3.EVENT.KEYPRESS="onkeypress";jsx3.EVENT.KEYUP="onkeyup";jsx3.EVENT.KEYDOWN="onkeydown";jsx3.EVENT.FOCUS="onfocus";jsx3.EVENT.ACTIVATE="onactivate";jsx3.EVENT.BLUR="onblur";jsx3.EVENT.SCROLL="onscroll";jsx3.EVENT.UNLOAD="onunload";jsx3.EVENT.BEFOREUNLOAD="onbeforeunload";jsx3.EVENT.JSXKEYUP="jsxkeyup";jsx3.EVENT.JSXKEYDOWN="jsxkeydown";jsx3.EVENT.JSXKEYUP="jsxkeyup";jsx3.EVENT.JSXKEYPRESS="jsxkeypress";jsx3.EVENT.JSXBLUR="jsxblur";jsx3.EVENT.JSXCLICK="jsxclick";jsx3.EVENT.JSXDOUBLECLICK="jsxdblclick";jsx3.EVENT.JSXMOUSEDOWN="jsxmousedown";jsx3.EVENT.SPYGLASS="jsxspy";jsx3.EVENT.DROP="jsxdrop";jsx3.EVENT.BEFOREDROP="jsxbeforedrop";jsx3.EVENT.CANCELDROP="jsxcanceldrop";jsx3.EVENT.CTRLDROP="jsxctrldrop";jsx3.EVENT.DRAG="jsxdrag";jsx3.EVENT.ADOPT="jsxadopt";jsx3.EVENT.SHOW="jsxshow";jsx3.EVENT.HIDE="jsxhide";jsx3.EVENT.MENU="jsxmenu";jsx3.EVENT.SELECT="jsxselect";jsx3.EVENT.TOGGLE="jsxtoggle";jsx3.EVENT.EXECUTE="jsxexecute";jsx3.EVENT.BEFORERESIZE="jsxbeforeresize";jsx3.EVENT.AFTERRESIZE="jsxafterresize";jsx3.EVENT.BEFOREMOVE="jsxbeforemove";jsx3.EVENT.AFTERMOVE="jsxaftermove";jsx3.EVENT.DESTROY="jsxdestroy";jsx3.EVENT.SORT="jsxsort";jsx3.EVENT.BEFORESORT="jsxbeforesort";jsx3.EVENT.AFTERSORT="jsxaftersort";jsx3.EVENT.PAINT="jsxpaint";jsx3.EVENT.PAGE="jsxpage";jsx3.EVENT.INTERVAL="jsxinterval";jsx3.EVENT.DRAW="jsxdraw";jsx3.EVENT.DATA="jsxdata";jsx3.EVENT.BEFOREEDIT="jsxbeforeedit";jsx3.EVENT.AFTEREDIT="jsxafteredit";jsx3.EVENT.CHANGE="jsxchange";jsx3.EVENT.INCCHANGE="jsxincchange";jsx3.EVENT.BEFOREAPPEND="jsxbeforeappend";jsx3.EVENT.AFTERAPPEND="jsxafterappend";jsx3.Class.defineClass("jsx3.app.Browser",null,null,function(a,s){a.WIN32="win32";a.LINUX="linux";a.MACOSX="macosx";a.OTHER="other";a.getLocaleString=function(){var
Ec=window.navigator.userLanguage;var
...
Ac=0;Ac<sb.rules.length;Ac++){var
uc=sb.rules[Ac];a.tQ[uc.selectorText]=uc.style;}}}return a.tQ[q];};a.getLocation=function(){if(a.VG==null)a.VG=new
...
qc=this.Ku();var
C=null;if(n==null)n="";if(d==3){C=qc.createTextNode(k);}else if(d==4){C=qc.createCDATASection(k);}else if(d==8){C=qc.createComment(k);}else C=qc.createNode(d,k,n);return new
m(C);};a.cloneNode=function(n){if(this.Nu==1){var
Bb=this.bX.cloneNode(n);return new
m(Bb);}else this.Kl(301,jsx3._msg("xml.clone_tp",this.Nu));};a.appendChild=function(p){var
_=p.bX;if(this.bX!=null&&_!=null&&this.Nu==1){this.bX.appendChild(_);}else this.Kl(302,jsx3._msg("xml.err_append",p));return this;};a.insertBefore=function(o,d){if(d==null){if(this.Nu==1){this.appendChild(o);return o;}}else{var
ec=o.bX;if(this.Nu==1&&d.Nu!=2&&o.Nu!=2)if(d.getParent()!=null&&d.getParent().equals(this)){var
Sb=new
m(this.bX.insertBefore(ec,d.bX));return Sb;}return null;}};a.replaceNode=function(d,q){var
kc=d.bX;if(this.Nu==1&&q.Nu==1&&d.Nu==1)if(q.getParent()!=null&&q.getParent().equals(this)&&q.getParent()!=null&&q.getParent().equals(this)){var
I=new
m(this.bX.replaceChild(kc,q.bX));return I;}return null;};a.setAttribute=function(g,h){if(h!=null)this.bX.setAttribute(g,String(h));else this.removeAttribute(g);return this;};a.getAttribute=function(f){return this.bX?this.bX.getAttribute(f):null;};a.getAttributeNode=function(l){if(this.bX!=null&&this.Nu==1){var
pb=this.bX.getAttributeNode(l);if(pb!=null)return new
m(pb);}};a.setAttributeNode=function(h){var
E=h.bX;this.bX.setAttributeNode(E);return this;};a.getAttributes=function(){if(this.bX!=null&&this.Nu==1)return new
m.List(this.bX.attributes);else return null;};a.getAttributeNames=function(){var
kc=this.bX.attributes;var
B=new
Array(kc.length);for(var
Ic=0;Ic<B.length;Ic++)B[Ic]=kc[Ic].nodeName;return B;};a.getRootNode=function(){return this.bX?new
m(this.Ku(1)):null;};a.getParent=function(){return this.bX!=this.Ku(1)?new
m(this.bX.parentNode):null;};a.getChildIterator=function(h){return new
m.ChildIterator(this.bX?this.bX.childNodes:[],h);};a.getChildNodes=function(c){if(!this.bX)return new
m.List([]);var
Ab=this.bX.childNodes;var
Mc=[];for(var
Ob=0;Ob<Ab.length;Ob++){var
Db=Ab[Ob];if(Db.nodeType==1||c&&(Db.nodeType==3||Db.nodeType==4))Mc[Mc.length]=Db;}return new
m.List(Mc);};a.removeChild=function(o){var
sb=o.getParent();return sb!=null&&sb.equals(this)?new
m(this.bX.removeChild(o.bX)):null;};a.removeChildren=function(){var
t=this.bX.childNodes;for(var
sb=t.length-1;sb>=0;sb--)this.bX.removeChild(t[sb]);};a.removeAttribute=function(n){if(this.Nu==1)this.bX.removeAttribute(n);};a.removeAttributeNode=function(s){this.bX.removeAttributeNode(s.bX);return this;};a.equals=function(o){return o.bX==this.bX;};a.getNodeType=function(){return this.Nu;};a.getNodeName=function(){return this.bX.nodeName;};a.getNamespaceURI=function(){var
Zb=this.bX.namespaceURI;if(Zb==null)Zb="";return Zb;};a.selectSingleNode=function(p,o){if(!this.bX)return null;return this.jm(p,o,0);};a.selectNodes=function(c,i){if(!this.bX)return new
m.List([]);return this.jm(c,i,1);};a.selectNodeIterator=function(i,k){if(!this.bX)return new
m.SelectIterator();return this.jm(i,k,2);};a.getBaseName=function(){return this.bX.baseName;};a.getPrefix=function(){return this.bX.prefix;};a.getXML=function(){return this.bX.xml;};a.toString=function(){var
Cc="@"+this.getClass().getName();if(this.bX!=null&&!this.hasError()){return this.bX.xml?this.bX.xml:this.bX.outerHTML?this.bX.outerHTML:jsx3._msg("xml.str_unk",Cc);}else return this.hasError()?jsx3._msg("xml.str_err",Cc,this.getError()):jsx3._msg("xml.str_empty",Cc);};a.getValue=function(){return this.Nu==1?this.bX.text:this.bX.nodeValue;};a.setValue=function(n){if(n==null)n="";if(this.Nu==1){this.bX.text=n;}else this.bX.nodeValue=n;return this;};a.jm=function(n,q,g){if(typeof q=="object")q=jsx3.xml.Document.Ii(q);var
wc,L=null;if(q!=null){L=this.bX.ownerDocument;wc=L.getProperty("SelectionNamespaces");L.setProperty("SelectionNamespaces",q);}var
bb=null;if(g){try{var
Cb=this.bX.selectNodes(n);}catch(Kc){}if(!Cb)Cb=[];bb=g==2?new
m.SelectIterator(Cb):new
m.List(Cb);}else{try{var
F=this.bX.selectSingleNode(n);}catch(Kc){}bb=F?new
m(F):null;}if(L)L.setProperty("SelectionNamespaces",wc);return bb;};a.Ku=function(l){if(l==null){return this.bX.ownerDocument;}else if(l==1){var
dc=this.bX.ownerDocument;return dc!=null?dc.documentElement:null;}else if(l==2)return this.bX.documentElement;};a.getNative=function(){return this.bX;};a.getFirstChild=function(){if(this.Nu==1){var
Fc=this.bX.firstChild;while(Fc!=null&&Fc.nodeType!=1)Fc=Fc.nextSibling;if(Fc!=null)return new
m(Fc);}return null;};a.getLastChild=function(){if(this.Nu==1){var
Pb=this.bX.lastChild;while(Pb!=null&&Pb.nodeType!=1)Pb=Pb.previousSibling;if(Pb!=null)return new
m(Pb);}return null;};a.getPreviousSibling=function(){if(this.Nu==1){var
X=this.bX.previousSibling;while(X!=null&&X.nodeType!=1)X=X.previousSibling;if(X!=null)return new
m(X);}return null;};a.getNextSibling=function(){if(this.Nu==1){var
Gb=this.bX.nextSibling;while(Gb!=null&&Gb.nodeType!=1)Gb=Gb.nextSibling;if(Gb!=null)return new
m(Gb);}return null;};a.transformNode=function(e,o,q){jsx3.require("jsx3.xml.Template");var
Vb=new
jsx3.xml.Template(e);if(o)Vb.setParams(o);return Vb[q?"transformToObject":"transform"](this);};m.zN=function(){};m.zN.prototype.toString=function(){return "["+this.code+"]"+(typeof this.description!="undefined"?" "+this.description:"");};a.Kl=function(l,s){if(this.ey==null)this.ey=new
m.zN();this.ey.code=l;this.ey.description=s;};a.getError=function(){if(!this.ey)this.Kl(0);return this.ey;};a.hasError=function(){return this.ey!=null&&this.ey.code!=0;};a.getOwnerDocument=function(){return this.bX?new
...
ib=jsx3.Exception;i.init=function(j){this.jsxsuper(null,true);this.ei=j;};i.get=function(o){var
sb=this.ei[o];return sb!=null?new
jsx3.xml.Entity(sb):sb;};var
y="Not implemented";i.add=function(){throw new
ib(y);};i.addAll=function(){throw new
ib(y);};i.set=function(){throw new
ib(y);};i.remove=function(){throw new
ib(y);};i.removeAt=function(){throw new
ib(y);};i.sort=function(){throw new
ib(y);};i.slice=function(g,n){return new
s(arguments.length>1?this.ei.slice(g,n):this.ei.slice(g));};i.toString=function(){return "["+this.toArray()+"]";};i.clone=function(){return new
s(this.ei.concat());};i.toArray=function(){var
Mc=this.size();var
Hb=new
Array(Mc);for(var
B=0;B<Mc;B++)Hb[B]=this.get(B);return Hb;};});jsx3.Class.defineClass("jsx3.xml.Entity.ChildIterator",null,[jsx3.util.Iterator],function(f,j){j.init=function(n,q){this.YS=n;this.hK=0;this.l8=q;this.CT();this.bX=null;};j.next=function(){if(!this._next)return null;if(this.bX){this.bX.init(this._next);}else this.bX=new
jsx3.xml.Entity(this._next);this.CT();return this.bX;};j.hasNext=function(){return this._next!=null;};j.CT=function(){this._next=null;var
W=this.YS;var
mc=W.length;while(this._next==null&&this.hK<mc){var
jc=W[this.hK];if(jc.nodeType==1||this.l8&&(jc.nodeType==3||jc.nodeType==4))this._next=jc;this.hK++;}};});jsx3.Class.defineClass("jsx3.xml.Entity.SelectIterator",null,[jsx3.util.Iterator],function(g,k){k.init=function(c){this.ZD=c;this.rI=0;this.bX=null;};k.next=function(){var
ec=this.ZD[this.rI++];if(!ec)return null;if(this.bX){this.bX.init(ec);}else this.bX=new
jsx3.xml.Entity(ec);return this.bX;};k.hasNext=function(){return this.ZD&&this.rI<this.ZD.length;};});jsx3.Collection=jsx3.xml.Entity.List;jsx3.util.Collection=jsx3.Collection;jsx3.Class.defineClass("jsx3.xml.Document",jsx3.xml.Entity,[jsx3.util.EventDispatcher],function(e,m){var
Mb=jsx3.xml.Entity;e.ON_RESPONSE="response";e.ON_ERROR="error";e.ON_TIMEOUT="timeout";e.SEARCHABLE_NAMESPACE="http://xsd.tns.tibco.com/gi/cxf/2006";e.SEARCHABLE_PREFIX="jsx_xmlns";e.DV=/xmlns:([^=]*)=['\"]([^\"^']*)['\"]/g;try{e.ns=jsx3.getXmlInstance();}catch(Kc){}m.init=function(a){if(a==null){try{if(e.ns==null){this.Kl(100,jsx3._msg("xml.parser",null));return;}this.O_=e.ns.cloneNode(true);this.O_.async=false;this.O_.validateOnParse=false;this.O_.resolveExternals=false;this.O_.preserveWhiteSpace=true;this.O_.setProperty("ForcedResync",false);}catch(Kc){this.Kl(101,jsx3._msg("xml.parser",jsx3.NativeError.wrap(Kc)));delete this.O_;}}else{this.O_=a;this.jsxsuper(a.documentElement);}};m.load=function(k,r){this.oJ=k.toString();var
jc=jsx3.net.URIResolver.DEFAULT.resolveURI(k);this.Kl(0);var
Fb=this.getAsync()?true:false;this.O_.async=Fb;if(this.getAsync()){jsx3.sleep(function(){if(r>0)this._jsx_4=window.setTimeout(jsx3.makeCallback(function(){this.iC();},this),r);this.nO(jc,r,true);if(this.hasError()){this.BY();this.publish({subject:"error"});}},null,this);}else this.nO(jc,null,false);return this;};m.EY=function(r){Mb.prototype.init.call(this,r);if(jsx3.getXmlVersion()>3){var
zc=[];var
kc=this.getAttributeNames();for(var
zb=0;zb<kc.length;zb++){var
Qb=kc[zb];if(Qb.indexOf("xmlns:")==0)zc[zc.length]=Qb+'="'+this.getAttribute(Qb)+'"';}this.setSelectionNamespaces(zc.join(" "));}};m.nO=function(p,s,r){e.ev(6,jsx3._msg("xml.doc_load",p));try{if(r)this.O_.onreadystatechange=jsx3.makeCallback(function(){this.aF();},this);this.O_.load(p.toString());if(!r&&!this.B6(this.O_))this.EY(this.O_.documentElement);}catch(Kc){this.B6(this.O_,jsx3.NativeError.wrap(Kc));}};m.loadXML=function(q){this.oJ=null;this.Kl(0);try{this.O_.loadXML(q);if(!this.B6(this.O_))this.EY(this.O_.documentElement);}catch(Kc){this.B6(this.O_,jsx3.NativeError.wrap(Kc));}return this;};m.getSourceURL=function(){return this.oJ;};m.B6=function(o,s){if(o!=null){var
t=o.parseError;if(t!=null&&t.errorCode!="0"){var
ib=jsx3._msg("xml.err_fmt",t.errorCode,t.line,t.linepos,jsx3.util.strTrim(String(t.reason)),jsx3.util.strTruncate(t.srcText),t.url);this.Kl(t.errorCode,ib);return true;}}if(s!=null){this.Kl(110,jsx3._msg("xml.unknown",jsx3.NativeError.wrap(s)));return true;}return false;};m.getValidateOnParse=function(){return this.O_.validateOnParse;};m.setValidateOnParse=function(d){this.O_.validateOnParse=d;};m.getResolveExternals=function(){return this.O_.resolveExternals;};m.setResolveExternals=function(l){this.O_.resolveExternals=l;};m.aF=function(){var
x=this.O_.readyState;if(x==4){this.BY();jsx3.sleep(this.sY,null,this);}};m.sY=function(){if(this.B6(this.O_)){this.publish({subject:"error"});}else{this.EY(this.O_.documentElement);this.publish({subject:"response"});}};m.iC=function(){this.BY();this.Kl(111,jsx3._msg("xml.timeout"));this.publish({subject:"timeout"});};m.BY=function(){window.clearTimeout(this._jsx_4);this._jsx_4=null;this.O_.onreadystatechange=new
Function();};m.toString=function(){if(this.O_!=null&&!this.hasError()){var
vb=this.O_.xml;if(vb.charCodeAt(vb.length-1)==10&&vb.charCodeAt(vb.length-2)==13)vb=vb.substring(0,vb.length-2);return vb;}else return this.jsxsuper();};m.getXmlVersion=function(){return this.OP("version");};m.getXmlEncoding=function(){return this.OP("encoding");};m.getXmlStandalone=function(){return this.OP("standalone")=="yes";};m.OP=function(a){var
lc=this.O_.childNodes[0];if(lc.nodeType==7&&lc.nodeName=="xml"){var
L=new
RegExp("\\b"+a+'="(.*?)"',"i");if(lc.nodeValue.match(L))return RegExp.$1;}return null;};m.cloneDocument=function(){return new
e(this.O_.cloneNode(true));};m.serialize=function(i,h,c){if(i===true)i=this.getXmlVersion()||"1.0";if(h===true)h=this.getXmlEncoding();var
mb=i||h||c;if(mb){var
Q="<?xml";if(i)Q=Q+(' version="'+i+'"');if(h)Q=Q+(' encoding="'+h+'"');if(c!=null)Q=Q+(' standalone="'+(c?"yes":"no")+'"');Q=Q+"?>\n";var
Hc=new
Array(this.O_.childNodes.length+1);Hc[0]=Q;for(var
Dc=0;Dc<this.O_.childNodes.length;Dc++){var
Vb=this.O_.childNodes[Dc];if(Vb.nodeType!=7||Vb.nodeName!="xml"){var
kc=new
Mb(Vb);Hc[Dc+1]=kc.hasError()?"<!-- "+kc+" -->":kc.toString();}}}else{var
Hc=new
Array(this.O_.childNodes.length);for(var
Dc=0;Dc<this.O_.childNodes.length;Dc++){var
Vb=this.O_.childNodes[Dc];var
kc=new
Mb(Vb);Hc[Dc]=kc.hasError()?"<!-- "+kc+" -->":kc.toString();if(Vb.nodeType==7||Vb.nodeName=="xml")Hc[Dc]+="\n";}}return Hc.join("");};m.createDocumentElement=function(q,c){if(c){var
rb=this.O_.createNode(1,q,c);}else var
rb=this.O_.createElement(q);if(this.O_.documentElement!=null)this.O_.replaceChild(rb,this.O_.documentElement);else this.O_.appendChild(rb);this.EY(this.O_.documentElement);return new
jsx3.xml.Entity(rb);};m.createProcessingInstruction=function(b,j){var
bc=this.O_.createProcessingInstruction(b,j);this.O_.appendChild(bc);};m.setAsync=function(n){this._jsxxR=n;return this;};m.getAsync=function(f){return this._jsxxR==null?false:this._jsxxR;};m.setSelectionLanguage=function(r){this.O_.setProperty("SelectionLanguage",r);return this;};m.getSelectionLanguage=function(){return this.O_.getProperty("SelectionLanguage");};e.Ii=function(p){var
dc=[];for(var Jb in p)dc[dc.length]="xmlns:"+p[Jb]+"='"+Jb+"'";return dc.join(" ");};m.setSelectionNamespaces=function(l){if(typeof l=="object")l=e.Ii(l);try{this.O_.setProperty("SelectionNamespaces",l);}catch(Kc){this.Kl(113,jsx3._msg("xml.selns",l,jsx3.NativeError.wrap(Kc)));}return this;};m.getSelectionNamespaces=function(f){return this.O_.getProperty("SelectionNamespaces");};m.createNamespaceAxis=function(){var
y=this.getRootNode();var
I=y.toString();var
Tb="";do{var
Vb=new
RegExp("xmlns:"+"jsx_xmlns"+Tb+"([^=]*)=['\"]([^\"^']*)['\"]","g");var
gc=I.search(Vb);if(gc>=0)Tb=Tb==""?0:Tb+1;}while(gc>=0);this.nr(y,"jsx_xmlns"+Tb);return "jsx_xmlns"+Tb;};m.nr=function(b,n){var
Ic=b.cloneNode(false).getXML();var
sb;while(sb=e.DV.exec(Ic))if(RegExp.$1!=n){var
sc=b.createNode(2,n+":"+RegExp.$1,e.SEARCHABLE_NAMESPACE);sc.setValue(RegExp.$2);b.setAttributeNode(sc);}for(var
v=b.getChildIterator();v.hasNext();)this.nr(v.next(),n);};m.getDeclaredNamespaces=function(b){this._jsxmO={};var
_=this.getRootNode();if(_)this._getDeclaredNamespaces(_,{index:0},b);return this._jsxmO;};m._getDeclaredNamespaces=function(k,a,i){var
Ub=k.getNamespaceURI();if(Ub!=""){var
D;if(!this._jsxmO[Ub]||i&&(D=k.getPrefix())!=""&&typeof i[D]!="undefined")if(D){this._jsxmO[Ub]=D;}else{a.index+=1;this._jsxmO[Ub]="jsx"+a.index;}}if(k.getNodeType()==1)for(var
S=k.selectNodeIterator("attribute::* | child::*");S.hasNext();){var
Dc=S.next();if(Dc.getNodeType()==1||Dc.getNodeType()==2)this._getDeclaredNamespaces(Dc,a,i);}};m.getNativeDocument=function(){return this.O_;};e.ev=function(f,j){if(e.ST==null)if(jsx3.util.Logger){e.ST=jsx3.util.Logger.getLogger(e.jsxclass.getName());if(e.ST==null)return;}else return;e.ST.log(f,j);};e.getVersion=function(){return "3.0.0";};});jsx3.Document=jsx3.xml.Document;jsx3.Class.defineClass("jsx3.xml.Template",null,null,function(p,s){p.DISABLE_OUTPUT_ESCAPING=1;p.b9={};p.b9[1]=true;p.supports=function(d){return p.b9[d]||Boolean(0);};s.init=function(m){if(m.hasError())throw new
jsx3.Exception(jsx3._msg("temp.init_err",m.getError()));if(m.getBaseName()=="stylesheet"){try{this.XF={};for(var
nb=m.selectNodeIterator("/xsl:stylesheet/xsl:param");nb.hasNext();){var
Fb=nb.next();this.XF[Fb.getAttribute("name")]=Fb.getValue();}var
Mb=jsx3.getXslInstance();Mb.stylesheet=m.getNativeDocument();this.WQ=Mb.createProcessor();}catch(Kc){this.Kl(200,jsx3._msg("temp.nat_err",jsx3.NativeError.wrap(Kc)));}}else this.Kl(201,jsx3._msg("temp.root_elm"));};s.setParam=function(f,j){if(!this.cR)this.cR=new
jsx3.util.List();if(this.cR.indexOf(f)<0)this.cR.add(f);this.WQ.addParameter(f,j!=null?j.toString():"");};s.ON=function(j,b){this.WQ.input=j instanceof jsx3.xml.Document?j.getNativeDocument():j.getNative();this.WQ.transform();var
A=b?(new
jsx3.xml.Document()).loadXML(this.WQ.output):this.WQ.output;this.WQ.input=null;return A;};s.reset=function(){for(var vb in this.XF)this.WQ.addParameter(vb,this.XF[vb]);};s.setParams=function(e){for(var S in e)this.setParam(S,e[S]);};s.transform=function(j,b){if(this.hasError())throw new
jsx3.Exception(jsx3._msg("temp.temp_err",this.getError()));if(j.hasError())throw new
jsx3.Exception(jsx3._msg("temp.doc_err",j.getError()));try{return this.ON(j,b);}catch(Kc){this.Kl(204,jsx3._msg("temp.err",jsx3.NativeError.wrap(Kc)));return null;}};s.transformToObject=function(b){return this.transform(b,true);};});jsx3.xml.Entity.jsxclass.mixin(jsx3.xml.Template.prototype,true,["getError","hasError","Kl"]);jsx3.Class.defineClass("jsx3.xml.XslDocument",jsx3.xml.Document,null,function(k,e){e.setParam=function(i,m){this.o8().setParam(i,m);};e.setParams=function(n){this.o8().setParams(n);};e.reset=function(){if(this._N)this._N.reset();};e.transform=function(n){return this.o8().transform(n);};e.transformToObject=function(d){return this.o8().transformToObject(d);};e.o8=function(){if(this._N==null)this._N=new
jsx3.xml.Template(this);return this._N;};e.load=function(o){delete this._N;return this.jsxsuper(o);};e.loadXML=function(m){delete this._N;return this.jsxsuper(m);};e.hasError=function(){return this.jsxsuper()||this._N!=null&&this._N.hasError();};e.getError=function(){var
Dc=null;if(this._N)Dc=this._N.getError();if(!Dc)Dc=this.jsxsuper();return Dc;};k.wrap=function(f){return new
k(f.getNativeDocument());};e.cloneDocument=function(){return k.wrap(this.jsxsuper());};e.isMutable=function(){return this._N==null;};});jsx3.Class.defineClass("jsx3.xml.Processor",null,null,function(e,g){var
V=jsx3.xml.Template;e.DISABLE_OUTPUT_ESCAPING=1;e.supports=function(m){return V.supports(m);};g.init=function(p,a,q){this.lw=p;this.R_=a;this.cR=q;};g.setXML=function(m){this.lw=m;return this;};g.setXSL=function(d){this.R_=d;return this;};g.setParams=function(i){this.cR=i;return this;};g.transformToObject=function(){return this.transform(true);};g.transform=function(k){var
ec=new
V(this.R_);if(!ec.hasError()){if(this.cR)ec.setParams(this.cR);var
P=ec.transform(this.lw,k);if(!ec.hasError())return P;}var
v=ec.getError();this.Kl(v.code,v.description);return null;};});jsx3.xml.Entity.jsxclass.mixin(jsx3.xml.Processor.prototype,true,["getError","hasError","Kl"]);jsx3.Class.defineClass("jsx3.net.Request",null,[jsx3.util.EventDispatcher],function(q,p){q.STATUS_OK=200;q.STATUS_ERROR=400;q.EVENT_ON_RESPONSE="response";q.EVENT_ON_TIMEOUT="timeout";q._Y={};p.init=function(m){if(m!=null)q._Y[m]=this;try{this.oK=jsx3.getHttpInstance();}catch(Kc){throw new
jsx3.Exception(jsx3._msg("req_inst"),jsx3.NativeError.wrap(Kc));}};p.abort=function(){if(this._timeoutto){window.clearTimeout(this._timeoutto);delete this._timeoutto;}this.oK.onreadystatechange=new
Function();this.oK.abort();return this;};p.getAllResponseHeaders=function(){return this.oK.getAllResponseHeaders();};p.getResponseHeader=function(g){return this.oK.getResponseHeader(g);};p.getStatusText=function(){return this.oK.statusText;};p.getStatus=function(){var
Bc=this.hT!=null?this.hT:this.oK.status;return Bc==0?200:Bc;};p.getResponseText=function(){return this.oK.responseText;};p.getResponseXML=function(){var
T=this.oK.responseXML;var
jb=this.getResponseHeader("Content-Type");if(T&&jb&&jb.match(/xml/)){if(T.documentElement)return new
jsx3.xml.Document(T);else q.ev(2,jsx3._msg("req.no_doc",this.oJ));}else{var
K=this.getResponseText();var
B=new
jsx3.xml.Document();B.loadXML(K);if(!B.hasError())return B;else q.ev(2,jsx3._msg("req.bad_xml",this.oJ,B.getError()));}return null;};p.setRequestHeader=function(h,g){this.oK.setRequestHeader(h,String(g));return this;};p.getReadyState=function(){return this.oK.readyState;};p.open=function(e,c,h,i,d){this.hT=0;c=c.toString();this.WJ=Boolean(h);this.P2=e;this.oJ=c;try{q.ev(6,jsx3._msg("req.open",c));this.oK.open(e,c,this.WJ,i,d);}catch(Kc){this.hT=400;q.ev(2,jsx3._msg("req.err_open",c,jsx3.NativeError.wrap(Kc)));}return this;};q.cancelRequest=function(k){var
xc=q._Y[k];if(xc)xc.abort();};q.getRequest=function(h){return q._Y[h];};p.getURL=function(){return this.oJ;};p.setTimeouts=function(f,a,o,d){try{this.oK.setTimeouts(f,a,o,d);}catch(Kc){q.ev(3,"The HTTP ActiveX object does not appear to support setting timeouts.");}return this;};p.send=function(h,o){if(this.hT==400)throw new
jsx3.Exception(jsx3._msg("req.err_state"));var
Nb=false;try{this.oK.send(h);if(this.WJ)this.hT=0;else delete this.hT;}catch(Kc){this.hT=400;q.ev(2,jsx3._msg("req.err_send",this.oJ,jsx3.NativeError.wrap(Kc)));Nb=this;}if(this.WJ)if(Nb||this.oK.readyState==4){jsx3.sleep(function(){this.publish({subject:"response"});},null,this);}else{var
zc=this;this.oK.onreadystatechange=function(){zc.Lw();};if(!isNaN(o)&&o>0)this._timeoutto=window.setTimeout(function(){zc.x9();},o);}return this;};p.x9=function(){delete this._timeoutto;this.abort();this.hT=408;this.publish({subject:"timeout"});};p.Lw=function(){if(this.oK.readyState==4){delete this.hT;if(this._timeoutto){window.clearTimeout(this._timeoutto);delete this._timeoutto;}this.oK.onreadystatechange=new
Function();this.publish({subject:"response"});}};p.toString=function(){return this.jsxsuper()+" "+this.P2+" "+this.getStatus()+" "+this.oJ;};q.ev=function(n,s){if(q.ST==null)if(jsx3.util.Logger){q.ST=jsx3.util.Logger.getLogger(q.jsxclass.getName());if(q.ST==null)return;}else return;q.ST.log(n,s);};q.getVersion=function(){return "3.00.00";};});jsx3.HttpRequest=jsx3.net.Request;jsx3.Class.defineClass("jsx3.util.Logger",null,null,function(h,m){var
qb=jsx3.Method;var
...
Mc=mb.getElementById("_jsx3_html_b2");if(parseInt(Mc.offsetWidth)>100)r.BC=1;u.removeChild(Mc);}u.removeChild(Jb);}return r.BC;};r.getScrollSizeOffset=function(o,d){return d=="scroll"?o:0;};r.addEventListener=function(o,a,f){o[a]=typeof f=="function"?f:new
Function(f);};r.removeEventListener=function(p,s,e){p[s]=null;};r.createRule=function(c,h,k){if(!k)k=document;var
Bb=k.getElementsByTagName("head")[0];var
wc=typeof k.createElementNS!="undefined"?k.createElementNS("http://www.w3.org/1999/xhtml","style"):k.createElement("style");wc.setAttribute("type","text/css");wc.setAttribute("media","screen");Bb.appendChild(wc);var
uc=k.styleSheets[k.styleSheets.length-1];if(typeof uc.addRule=="object")uc.addRule(c,h);};r.getRuleByName=function(k){var
Kc=document.styleSheets;for(var
zb=0;zb<Kc.length;zb++){var
Ib=Kc[zb];for(var
I=0;I<Ib.rules.length;I++)if(Ib.rules[I].selectorText+""==k)return Ib.rules[I];}return null;};r.copy=function(a){window.clipboardData.setData("text",a);};r.paste=function(){return window.clipboardData.getData("text");};r.getRelativePosition=function(m,s){var
lc=r.z3(s,m);return {L:lc.l,T:lc.t,W:s.offsetWidth,H:s.offsetHeight};};r.z3=function(d,i){var
Eb=0;var
uc=0;var
wb=0;var
Yb=0;var
G;if(d.offsetParent){while(d!=i){Eb=Eb+d.offsetLeft;uc=uc+d.offsetTop;if(d.offsetParent){G=d.offsetParent.style.borderLeftWidth?parseInt(d.offsetParent.style.borderLeftWidth):0;if(!isNaN(G))wb=wb+G;G=d.offsetParent.style.borderTopWidth?parseInt(d.offsetParent.style.borderTopWidth):0;if(!isNaN(G))Yb=Yb+G;}if(!d.offsetParent)break;d=d.offsetParent;Eb=Eb-d.scrollLeft;uc=uc-d.scrollTop;}}else if(d.x){Eb=Eb+d.x;uc=uc+d.y;}return {l:Eb+wb,t:uc+Yb};};r.scrollIntoView=function(l,a,d,s){var
wc=l.parentNode;while(wc!=null){var
tc=wc.tagName.toLowerCase();if(tc=="span"||tc=="div"){var
L=r.getRelativePosition(wc,l);if(wc.clientWidth+wc.scrollLeft<=L.L){wc.scrollLeft=L.L+l.offsetWidth-wc.clientWidth+d;}else if(wc.clientWidth+wc.scrollLeft<L.L+l.offsetWidth&&d!=null)wc.scrollLeft=L.L+l.offsetWidth-wc.clientWidth+d;if(wc.scrollLeft>=L.L+l.offsetWidth){wc.scrollLeft=L.L-d;}else if(wc.scrollLeft>L.L&&d!=null)wc.scrollLeft=L.L-d;if(wc.clientHeight+wc.scrollTop<=L.T){wc.scrollTop=L.T+l.offsetHeight-wc.clientHeight+s;}else if(wc.clientHeight+wc.scrollTop<L.T+l.offsetHeight&&s!=null)wc.scrollTop=L.T+l.offsetHeight-wc.clientHeight+s;if(wc.scrollTop>=L.T+l.offsetHeight){wc.scrollTop=L.T-s;}else if(wc.scrollTop>L.T&&s!=null)wc.scrollTop=L.T-s;}if(wc==a)break;wc=wc.parentNode;}};r.getOuterHTML=function(c){return c.outerHTML;};r.setOuterHTML=function(i,a){return i.outerHTML=a;};r.setInnerText=function(k,l){return k.innerText=l;};r.insertAdjacentHTML=function(i,a,p){i.insertAdjacentHTML(a,p);return p;};r.updateCSSOpacity=function(e,j){e.style.filter="alpha(opacity="+(isNaN(j)?j:j*100)+")";};r.getCSSOpacity=function(e){return "filter:alpha(opacity="+(isNaN(e)?e:e*100)+");";};r._FOCUSABLE={input:true,textarea:true,select:true,body:true,a:true,img:true,button:true,frame:true,iframe:true,object:true};r.isFocusable=function(n){return n.focus!=null&&(parseInt(n.getAttribute("jsxtabindex"))>=0||r._FOCUSABLE[n.tagName.toLowerCase()]);};r.getCSSFade=function(p){return r.getCSSPNG(p?jsx3.resolveURI("jsx:///images/icons/h.png"):jsx3.resolveURI("jsx:///images/icons/v.png"));};r.getCSSPNG=function(k){return "filter:progid:DXImageTransform.Microsoft.AlphaImageLoader(src='"+k+"', sizingMethod='scale');";};r.getJSXParent=function(b){while(b!=null){if(b.id&&b.id.indexOf("_jsx_")==0){var
Hc=jsx3.GO(b.id);if(Hc!=null)return Hc;}b=b.parentNode;}return null;};r.removeOutputEscaping=function(i){var
Gc=jsx3.util.List.wrap([i]);while(Gc.size()>0){var
u=Gc.removeAt(0);if(u.nodeName.toLowerCase()=="span"&&u.className=="disable-output-escp"){u.innerHTML=u.innerHTML.replace(/&lt;/g,"<").replace(/&gt;/g,">").replace(/&quot;/g,'"').replace(/&amp;/g,"&").replace(/&([a-zA-Z_]+);/g,r.dA);u.className="";}else Gc.addAll(u.childNodes);}};r.removeOutputEscapingSpan=function(f){return f.replace(/<span class=\"disable-output-escp\">([\s\S]*?)<\/span>/g,function(m,e){return e.replace(/&lt;/g,"<").replace(/&gt;/g,">").replace(/&quot;/g,'"').replace(/&amp;/g,"&").replace(/&([a-zA-Z_]+);/g,r.dA);});};r.oq={nbsp:160,copy:169,reg:174,deg:176,middot:183,le:8804,ge:8805,lt:60,gt:62,euro:8364,ndash:8211,mdash:8212,lsquo:8216,rsquo:8217,ldquo:8220,rdquo:8221,permil:8240};r.dA=function(n,l){var
B=r.oq[l];return B?"&#"+B+";":n;};r.QT="jsx_image_loader";r.loadImages=function(d){var
fb=document.getElementById(r.QT);if(fb==null){var
Lb=document.getElementsByTagName("body")[0];if(Lb){fb=document.createElement("div");fb.id=r.QT;fb.style.display="none";Lb.insertBefore(fb,Lb.firstChild);}else return;}var
Z=d instanceof Array?d:arguments;for(var
V=0;V<Z.length;V++){if(!Z[V])continue;var
N=jsx3.resolveURI(Z[V]);var
A=r.QT+"_"+N;if(document.getElementById(A)==null){var
hc=document.createElement("img");hc.setAttribute("id",A);hc.setAttribute("src",N);fb.appendChild(hc);}}};r.updateRule=function(f,i,o){var
sc=jsx3.html.getRuleByName(f);if(sc)sc.style[i]=o;};r.getElementById=function(h,a,o){return this.findElements(h,function(l){return l.id==a;},o,false,false,true);};r.getElementByTagName=function(f,d,m){d=d.toLowerCase();return this.findElements(f,function(q){return q.tagName.toLowerCase()==d;},m,false,false,true);};r.getElementsByTagName=function(d,b,k){b=b.toLowerCase();return this.findElements(d,function(o){return o.tagName.toLowerCase()==b;},k,true,false,true);};r.findElements=function(n,q,b,d,e,p){var
eb=b?"unshift":"push";var
x=d?[]:null;var
Bb=p?[n]:this.nodesToArray(n.childNodes);while(Bb.length>0){var
Fc=Bb.shift();if(q.call(null,Fc))if(d)x[x.length]=Fc;else return Fc;if(!e)Bb[eb].apply(Bb,this.nodesToArray(Fc.childNodes));}return x;};r.getElmUpByTagName=function(b,j,n){return r.findElementUp(b,function(f){return f.nodeName.toLowerCase()==j;},n);};r.findElementUp=function(a,s,m){var
N=a.ownerDocument.documentElement;var
B=m?a:a.parentNode;while(B!=null){if(s.call(null,B))return B;if(B==N)break;B=B.parentNode;}return null;};r.selectSingleElm=function(s,h){var
Bc=1,oc=arguments;if(arguments.length==2)if(typeof h=="string"){Bc=0;oc=h.split(/\//g);}else if(h instanceof Array){Bc=0;oc=h;}var
bc=s;for(var
gb=Bc;bc!=null&&gb<oc.length;gb++){var
zc=oc[gb];if(!isNaN(zc)){var
Pb=Number(zc);var
L=bc.childNodes.length;var
Lb=0,Ac=0;for(;Lb<L&&Ac<Pb;Lb++)if(bc.childNodes[Lb].nodeType==1)Ac++;bc=bc.childNodes[Lb];}else throw new
jsx3.Exception();}return bc;};r.nodesToArray=function(p){var
Ib=new
Array(p.length);for(var
L=0;L<p.length;L++)Ib[L]=p[L];return Ib;};r.getSelection=function(d){return new
r.Selection(d);};r.focusNext=function(b,k){var
Mb=b;while(Mb.lastChild)Mb=Mb.lastChild;while(!r.isFocusable(Mb)&&Mb!=b)Mb=Mb.previousSibling||Mb.parentNode;if(Mb!=b||r.isFocusable(Mb))if(Mb.onfocus!=null){var
Kc=Mb.onfocus;Mb.onfocus=null;Mb.focus();jsx3.sleep(function(){Mb.onfocus=Kc;});}else Mb.focus();};r.focusPrevious=function(l,a){var
Yb=this.findElements(l,function(i){return r.isFocusable(i);},true,false,false,true);if(Yb!=null)if(Yb.onfocus!=null){var
qc=Yb.onfocus;Yb.onfocus=null;Yb.focus();jsx3.sleep(function(){Yb.onfocus=qc;});}else Yb.focus();};});jsx3.Class.defineClass("jsx3.html.Selection",null,null,function(m,g){g.init=function(i){this.WD=i.ownerDocument.selection.createRange().duplicate();this.Su=i;};g.getStartIndex=function(){var
Tb=this.Su.ownerDocument.selection.createRange();var
yb=null;if(this.Su.tagName.toLowerCase()=="textarea"){yb=Tb.duplicate();yb.moveToElementText(this.Su);}else yb=this.Su.createTextRange();yb.setEndPoint("EndToEnd",Tb);return yb.text.length-Tb.text.length;};g.getEndIndex=function(){var
uc=this.Su.ownerDocument.selection.createRange();var
Db=null;if(this.Su.tagName.toLowerCase()=="textarea"){Db=uc.duplicate();Db.moveToElementText(this.Su);}else Db=this.Su.createTextRange();Db.setEndPoint("EndToEnd",uc);return Db.text.length;};g.setRange=function(r,f){var
Mb=this.Su.value;var
rc=/\r\n|\r|\n/g;var
u=f;while(rc.test(Mb)&&rc.lastIndex<=u){r=r-1;f=f-1;}var
tc=this.Su.createTextRange();tc.collapse(true);tc.moveStart("character",r);tc.moveEnd("character",f-r);tc.select();};g.getOffsetLeft=function(){return this.WD.offsetLeft;};g.getOffsetTop=function(){return this.WD.offsetTop;};g.getText=function(){return this.WD.text;};g.setText=function(i){this.WD.text=i;};g.insertCaret=function(i){if(i=="end"){this.WD.collapse();this.WD.select();}else throw new
jsx3.Exception();};});jsx3.Class.defineClass("jsx3.app.Cache",null,[jsx3.util.EventDispatcher],function(c,l){c.EVENT_CHANGE="change";l.init=function(){this.hK={};this.MX=[];this.wI={};};l.addParent=function(o){this.MX.push(o);};l.clearById=function(k){if(this.hK[k]!=null){delete this.hK[k];this.onChange();}};l.isSystem=function(r){return false;};l.clearByTimestamp=function(g){if(g instanceof Date)g=g.getTime();var
