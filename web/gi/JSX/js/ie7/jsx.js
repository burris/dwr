...
L=r.getRelativePosition(wc,l);if(wc.clientWidth+wc.scrollLeft<=L.L){wc.scrollLeft=L.L+l.offsetWidth-wc.clientWidth+d;}else if(wc.clientWidth+wc.scrollLeft<L.L+l.offsetWidth&&d!=null)wc.scrollLeft=L.L+l.offsetWidth-wc.clientWidth+d;if(wc.scrollLeft>=L.L+l.offsetWidth){wc.scrollLeft=L.L-d;}else if(wc.scrollLeft>L.L&&d!=null)wc.scrollLeft=L.L-d;if(wc.clientHeight+wc.scrollTop<=L.T){wc.scrollTop=L.T+l.offsetHeight-wc.clientHeight+s;}else if(wc.clientHeight+wc.scrollTop<L.T+l.offsetHeight&&s!=null)wc.scrollTop=L.T+l.offsetHeight-wc.clientHeight+s;if(wc.scrollTop>=L.T+l.offsetHeight){wc.scrollTop=L.T-s;}else if(wc.scrollTop>L.T&&s!=null)wc.scrollTop=L.T-s;}if(wc==a)break;wc=wc.parentNode;}};r.getOuterHTML=function(c){return c.outerHTML;};r.setOuterHTML=function(i,a){return i.outerHTML=a;};r.setInnerText=function(k,l){return k.innerText=l;};r.insertAdjacentHTML=function(i,a,p){i.insertAdjacentHTML(a,p);return p;};r.updateCSSOpacity=function(e,j){e.style.filter="alpha(opacity="+(isNaN(j)?j:j*100)+")";};r.getCSSOpacity=function(e){return "filter:alpha(opacity="+(isNaN(e)?e:e*100)+");";};r._FOCUSABLE={input:true,textarea:true,select:true,body:true,a:true,img:true,button:true,frame:true,iframe:true,object:true};r.isFocusable=function(n){return n.focus!=null&&(parseInt(n.getAttribute("jsxtabindex"))>=0||r._FOCUSABLE[n.tagName.toLowerCase()]);};r.getCSSFade=function(p){return r.getCSSPNG(p?jsx3.resolveURI("jsx:///images/icons/h.png"):jsx3.resolveURI("jsx:///images/icons/v.png"));};r.getCSSPNG=function(n){return "background-image:url("+n+");";};r.getJSXParent=function(l){while(l!=null){if(l.id&&l.id.indexOf("_jsx_")==0){var
Ib=jsx3.GO(l.id);if(Ib!=null)return Ib;}l=l.parentNode;}return null;};r.removeOutputEscaping=function(s){var
Wb=jsx3.util.List.wrap([s]);while(Wb.size()>0){var
W=Wb.removeAt(0);if(W.nodeName.toLowerCase()=="span"&&W.className=="disable-output-escp"){W.innerHTML=W.innerHTML.replace(/&lt;/g,"<").replace(/&gt;/g,">").replace(/&quot;/g,'"').replace(/&amp;/g,"&").replace(/&([a-zA-Z_]+);/g,r.dA);W.className="";}else Wb.addAll(W.childNodes);}};r.removeOutputEscapingSpan=function(l){return l.replace(/<span class=\"disable-output-escp\">([\s\S]*?)<\/span>/g,function(k,q){return q.replace(/&lt;/g,"<").replace(/&gt;/g,">").replace(/&quot;/g,'"').replace(/&amp;/g,"&").replace(/&([a-zA-Z_]+);/g,r.dA);});};r.oq={nbsp:160,copy:169,reg:174,deg:176,middot:183,le:8804,ge:8805,lt:60,gt:62,euro:8364,ndash:8211,mdash:8212,lsquo:8216,rsquo:8217,ldquo:8220,rdquo:8221,permil:8240};r.dA=function(l,a){var
nb=r.oq[a];return nb?"&#"+nb+";":l;};r.QT="jsx_image_loader";r.loadImages=function(e){var
fc=document.getElementById(r.QT);if(fc==null){var
J=document.getElementsByTagName("body")[0];if(J){fc=document.createElement("div");fc.id=r.QT;fc.style.display="none";J.insertBefore(fc,J.firstChild);}else return;}var
Ab=e instanceof Array?e:arguments;for(var
wb=0;wb<Ab.length;wb++){if(!Ab[wb])continue;var
T=jsx3.resolveURI(Ab[wb]);var
bb=r.QT+"_"+T;if(document.getElementById(bb)==null){var
Eb=document.createElement("img");Eb.setAttribute("id",bb);Eb.setAttribute("src",T);fc.appendChild(Eb);}}};r.updateRule=function(o,p,h){var
zc=jsx3.html.getRuleByName(o);if(zc)zc.style[p]=h;};r.getElementById=function(s,l,g){return this.findElements(s,function(j){return j.id==l;},g,false,false,true);};r.getElementByTagName=function(m,k,a){k=k.toLowerCase();return this.findElements(m,function(l){return l.tagName.toLowerCase()==k;},a,false,false,true);};r.getElementsByTagName=function(a,g,h){g=g.toLowerCase();return this.findElements(a,function(k){return k.tagName.toLowerCase()==g;},h,true,false,true);};r.findElements=function(k,a,s,g,e,m){var
bc=s?"unshift":"push";var
B=g?[]:null;var
Hb=m?[k]:this.nodesToArray(k.childNodes);while(Hb.length>0){var
yc=Hb.shift();if(a.call(null,yc))if(g)B[B.length]=yc;else return yc;if(!e)Hb[bc].apply(Hb,this.nodesToArray(yc.childNodes));}return B;};r.getElmUpByTagName=function(e,m,q){return r.findElementUp(e,function(p){return p.nodeName.toLowerCase()==m;},q);};r.findElementUp=function(j,k,c){var
xc=j.ownerDocument.documentElement;var
rc=c?j:j.parentNode;while(rc!=null){if(k.call(null,rc))return rc;if(rc==xc)break;rc=rc.parentNode;}return null;};r.selectSingleElm=function(m,n){var
W=1,pb=arguments;if(arguments.length==2)if(typeof n=="string"){W=0;pb=n.split(/\//g);}else if(n instanceof Array){W=0;pb=n;}var
Ib=m;for(var
vb=W;Ib!=null&&vb<pb.length;vb++){var
Ic=pb[vb];if(!isNaN(Ic)){var
N=Number(Ic);var
Mc=Ib.childNodes.length;var
y=0,sb=0;for(;y<Mc&&sb<N;y++)if(Ib.childNodes[y].nodeType==1)sb++;Ib=Ib.childNodes[y];}else throw new
jsx3.Exception();}return Ib;};r.nodesToArray=function(c){var
V=new
Array(c.length);for(var
Ib=0;Ib<c.length;Ib++)V[Ib]=c[Ib];return V;};r.getSelection=function(f){return new
r.Selection(f);};r.focusNext=function(k,b){var
Fb=k;while(Fb.lastChild)Fb=Fb.lastChild;while(!r.isFocusable(Fb)&&Fb!=k)Fb=Fb.previousSibling||Fb.parentNode;if(Fb!=k||r.isFocusable(Fb))if(Fb.onfocus!=null){var
T=Fb.onfocus;Fb.onfocus=null;Fb.focus();jsx3.sleep(function(){Fb.onfocus=T;});}else Fb.focus();};r.focusPrevious=function(j,c){var
lb=this.findElements(j,function(l){return r.isFocusable(l);},true,false,false,true);if(lb!=null)if(lb.onfocus!=null){var
F=lb.onfocus;lb.onfocus=null;lb.focus();jsx3.sleep(function(){lb.onfocus=F;});}else lb.focus();};});jsx3.Class.defineClass("jsx3.html.Selection",null,null,function(b,o){o.init=function(f){this.WD=f.ownerDocument.selection.createRange().duplicate();this.Su=f;};o.getStartIndex=function(){var
Ec=this.Su.ownerDocument.selection.createRange();var
T=null;if(this.Su.tagName.toLowerCase()=="textarea"){T=Ec.duplicate();T.moveToElementText(this.Su);}else T=this.Su.createTextRange();T.setEndPoint("EndToEnd",Ec);return T.text.length-Ec.text.length;};o.getEndIndex=function(){var
Kb=this.Su.ownerDocument.selection.createRange();var
Lc=null;if(this.Su.tagName.toLowerCase()=="textarea"){Lc=Kb.duplicate();Lc.moveToElementText(this.Su);}else Lc=this.Su.createTextRange();Lc.setEndPoint("EndToEnd",Kb);return Lc.text.length;};o.setRange=function(e,l){var
t=this.Su.value;var
cc=/\r\n|\r|\n/g;var
O=l;while(cc.test(t)&&cc.lastIndex<=O){e=e-1;l=l-1;}var
ec=this.Su.createTextRange();ec.collapse(true);ec.moveStart("character",e);ec.moveEnd("character",l-e);ec.select();};o.getOffsetLeft=function(){return this.WD.offsetLeft;};o.getOffsetTop=function(){return this.WD.offsetTop;};o.getText=function(){return this.WD.text;};o.setText=function(q){this.WD.text=q;};o.insertCaret=function(d){if(d=="end"){this.WD.collapse();this.WD.select();}else throw new
