...
kb=new
jsx3.vector.Fill(e.getColor(),e.getAlpha());kb.setType("gradient");kb.setColor2(z[0]);kb.setAngle(z[1]);kb.setAlpha2(z[2]);kb.setColors(z[3]);return kb;}else return e;};});if(jsx3.IDE){jsx3.ide.loadTemplateCatalog("prop","properties/catalog.xml",jsx3.chart.ADDIN);jsx3.ide.loadTemplateCatalog("event","events/catalog.xml",jsx3.chart.ADDIN);}jsx3.Package.definePackage("jsx3.vector",function(g){g.Li="px";g.Yh="http://www.w3.org/2000/svg";g.aj=function(s){return typeof s=="number"?"#"+(s+16777216).toString(16).substring(1):""+s;};g.Zj=function(m,q,b){if(m==null)m=0;if(q==null)q="px";if(typeof m=="number"){return m+""+q;}else{m=m.toString();m=m.replace(/^\s*(.*?)\s*$/,"$1");if(b)m=m.replace(/[^\d\.]/g,"");return m.match(/[^\d\.]/)?m:m+""+q;}};g.Ud=function(s){return Math.max(0,Math.min(1,s));};g.degreesToRadians=function(d){return jsx3.util.numMod(2*Math.PI/360*(-1*d+90),2*Math.PI);};});jsx3.Class.defineClass("jsx3.html.Tag",null,null,function(g,q){var
...
G=parseInt(v[0]);return [G,G,G,G];}}return [0,0,0,0];};l.getDimensions=function(){return [this.getLeft(),this.getTop(),this.getWidth(),this.getHeight()];};l.setDimensions=function(k,n,i,o){if(k instanceof Array){this.setLeft(k[0]);this.setTop(k[1]);this.setWidth(k[2]);this.setHeight(k[3]);}else{this.setLeft(k);this.setTop(n);this.setWidth(i);this.setHeight(o);}};});jsx3.Class.defineInterface("jsx3.html.FontTag",null,function(q,s){s.getFontFamily=function(){return this.getStyle("fontFamily");};s.setFontFamily=function(a){this.setStyle("fontFamily",a);};s.getFontSize=function(){return this.getStyle("fontSize");};s.setFontSize=function(h){this.setStyle("fontSize",isNaN(h)?h:h+"px");};s.getFontStyle=function(){return this.getStyle("fontStyle");};s.setFontStyle=function(f){this.setStyle("fontStyle",f);};s.getFontWeight=function(){return this.getStyle("fontWeight");};s.setFontWeight=function(e){this.setStyle("fontWeight",e);};s.getTextAlign=function(){return this.getStyle("textAlign");};s.setTextAlign=function(l){this.setStyle("textAlign",l);};s.getTextDecoration=function(){return this.getStyle("textDecoration");};s.setTextDecoration=function(j){this.setStyle("textDecoration",j);};s.getColor=function(){return this.getStyle("color");};s.setColor=function(r){this.setStyle("color",r);};});jsx3.Class.defineClass("jsx3.vector.Canvas",jsx3.html.BlockTag,null,function(s,a){a.init=function(g,j,m,k){this.jsxsuper(jsx3.vector.Yh,"svg",g,j,m,k);this.setProperty("version","1.1","baseProfile","full","xmlns:xlink","http://www.w3.org/1999/xlink");};a.paintUpdate=function(){this.jsxsuper();if(this.d4!=null&&this.d4.getParent()==null)this.appendChild(this.d4);if(this.getPosition()!="absolute"){this.setLeft(null);this.setTop(null);}};a.getDefs=function(){if(this.d4==null){this.d4=new
jsx3.html.Tag(jsx3.vector.Yh,"defs");this.appendChild(this.d4);}return this.d4;};a.setWidth=function(d){this.jsxsuper(d);this.setProperty("width",typeof d=="number"?d+"px":d);};a.setHeight=function(g){this.jsxsuper(g);this.setProperty("height",typeof g=="number"?g+"px":g);};});jsx3.Class.defineClass("jsx3.vector.Tag",jsx3.html.BlockTag,null,function(j,a){a.init=function(q,b,e,r,f){this.jsxsuper(jsx3.vector.Yh,q,b,e,r,f);};a.getToolTip=function(){return this.getProperty("title");};a.setToolTip=function(q){this.setProperty("title",q);};a.setRotation=function(h){this.Ww=h;};a.setLeft=function(d){this.eP=d;};a.setTop=function(b){this.Vp=b;};a.setWidth=function(d){this.qA=d;};a.setHeight=function(b){this.rA=b;};a.setPosition=function(o){this.fK=o;};a.getRotation=function(){return this.Ww;};a.getLeft=function(){return this.eP;};a.getTop=function(){return this.Vp;};a.getWidth=function(){return this.qA;};a.getHeight=function(){return this.rA;};a.getPosition=function(){return this.fK;};a.setZIndex=function(h){this.jsxsuper(h);var
T=this.getParent();if(T){var
U=T.getChildren();for(var
Fc=0;Fc<U.length;Fc++){var
y=U[Fc];if(y instanceof j){var
nc=parseInt(y.getZIndex());if(h<nc){if(y!=this){T.Xd.removeChild(this.Xd);T.Xd.insertBefore(this.Xd,y.Xd);}break;}}}}};a.appendChild=function(n){if(this.Qc(n)){if(n instanceof j&&n.getParent()!=null)throw new
jsx3.Exception("can't append "+n+" to "+this+", already has parent "+n.Kv);if(this.q1==null)this.q1=[];if(n instanceof j){var
X=parseInt(n.getZIndex());if(!isNaN(X))for(var
ub=0;ub<this.q1.length;ub++){var
Cc=this.q1[ub];var
db=parseInt(Cc.getZIndex());if(X<db)this.Xd.insertBefore(n.Xd,Cc.Xd);}}if(n.Xd.parentNode==null)this.Xd.appendChild(n.Xd);this.q1.push(n);n.Kv=this;}else throw new
jsx3.Exception("Illegal to append child "+n+" to parent "+this+".");};a.getDefs=function(){var
vc=this.getParent();return vc!=null?vc.getDefs():null;};});jsx3.Class.defineClass("jsx3.vector.Stroke",jsx3.html.Tag,null,function(m,s){var
gb=jsx3.vector;m.en=null;s.init=function(p,j,h){this.jsxsuper(gb.Yh,m.en);this.vv=null;this.P5=p!=null?p:0;this.qA=j!=null?j:1;this.yY=h!=null?gb.Ud(h):1;};s.getColor=function(){return this.P5;};s.getColorHtml=function(){return gb.aj(this.P5);};s.setColor=function(e){this.P5=e;};s.getWidth=function(){return this.qA;};s.setWidth=function(n){this.qA=n;};s.getAlpha=function(){return this.yY;};s.setAlpha=function(p){this.yY=p!=null?gb.Ud(p):null;};s.Qc=function(n){return false;};s.toString=function(){return "<stroke "+this.getColorHtml()+" "+this.qA+" "+this.yY+"/>";};s.paint=function(){var
qb="<"+gb.Yh+":"+this.getTagName();if(this.getId()!=null)qb=qb+(" id='"+this.getId()+"'");var
db=this.getColorHtml();if(this.vv!=null)qb=qb+(" on='"+this.vv+"'");if(db!=null)qb=qb+(" color='"+db+"'");if(this.yY!=null&&this.yY<1)qb=qb+(" opacity='"+this.yY+"'");if(this.qA!=null)qb=qb+(" weight='"+gb.Zj(this.qA)+"'");qb=qb+"/>";return qb;};s.Jd=function(){return this.yY==1||this.yY==null;};m.valueOf=function(a){if(jsx3.util.strEmpty(a))return null;if(a instanceof m)return a;var
Kb=a.toString().split(/\s+/);return new
m(Kb[0],Kb[1],Kb[2]);};});jsx3.Class.defineClass("jsx3.vector.Fill",jsx3.html.Tag,null,function(c,b){var
gb=jsx3.vector;c.en=null;b.init=function(e,m){this.jsxsuper(gb.Yh,c.en);this.vv=null;this.P5=e!=null?e:0;this.yY=m!=null?gb.Ud(m):1;this.n8=null;this.L2=null;this.Sp=null;this.vJ=null;this.CR=null;};b.getColor=function(){return this.P5;};b.getColorHtml=function(){return gb.aj(this.P5);};b.setColor=function(s){this.P5=s;};b.getAlpha=function(){return this.yY;};b.setAlpha=function(l){this.yY=l!=null?gb.Ud(l):null;};b.getType=function(){return this.n8;};b.setType=function(g){this.n8=g;};b.getColor2=function(){return this.L2;};b.getColor2Html=function(){return gb.aj(this.L2);};b.setColor2=function(n){this.L2=n;};b.getAlpha2=function(){return this.Sp;};b.setAlpha2=function(m){this.Sp=m;};b.getAngle=function(){return this.vJ;};b.setAngle=function(l){this.vJ=l;};b.getColors=function(){return this.CR;};b.setColors=function(l){this.CR=l;};b.toString=function(){return "<fill "+this.getColorHtml()+" "+this.getAlpha()+"/>";};b.hasGradient=function(){return this.n8&&this.n8!="solid";};b.Jd=function(){return (this.yY==1||this.yY==null)&&!this.hasGradient();};c.valueOf=function(n){if(jsx3.util.strEmpty(n))return null;if(n instanceof c)return n;var
Ec=n.toString().split(/\s+/);return new
c(Ec[0],Ec[1]);};b.Qc=function(q){return false;};});jsx3.Class.defineClass("jsx3.vector.Group",jsx3.vector.Tag,null,function(i,k){k.init=function(p,s,d,a){this.jsxsuper(i.en,p,s,d,a);};i.en="g";k.paintUpdate=function(){this.jsxsuper();var
I=this.getLeft()||Number(0);var
yc=this.getTop()||Number(0);if(I||yc)this.setProperty("transform","translate("+I+","+yc+")");};k.Qc=function(r){return r instanceof i||r instanceof jsx3.vector.Shape;};});jsx3.Class.defineClass("jsx3.vector.Shape",jsx3.vector.Tag,null,function(l,g){var
xc=jsx3.html.Tag;var
Ac=jsx3.vector;g.init=function(s,f,c,a,d){this.jsxsuper(s!=null?s:l.en,f,c,a,d);this.bf=null;this.mp=null;};g.getPath=function(){return this.getProperty("d");};g.setPath=function(e){this.setProperty("d",e);};g.dl=function(c,b,m){this.B7((m?"m":"M")+" "+c+" "+b);return this;};g.pj=function(a,s,k){this.B7((k?"l":"L")+" "+a+" "+s);return this;};g.Aj=function(p,o,j,f,i,m,e,r,a){var
ab=Math.sqrt(Math.pow(i-p,2)+Math.pow(m-o,2));var
Rb=Math.sqrt(Math.pow(e-p,2)+Math.pow(r-o,2));var
C=Math.asin((o-m)/ab);if(i-p<0)C=(C>0?Math.PI:-Math.PI)-C;var
qb=Math.asin((o-r)/Rb);if(e-p<0)qb=(qb>0?Math.PI:-Math.PI)-qb;var
sc=a?C-qb:qb-C;var
z=sc>-1*Math.PI&&sc<0||sc>Math.PI;this.pj(i,m).B7("A "+j+" "+f+" 0 "+(z?"1":"0")+" "+(a?"1":"0")+" "+e+" "+r);return this;};g.Bh=function(){this.B7("z");return this;};g.B7=function(f){var
Jc=this.getPath();if(!Jc)this.setPath(f);else this.setPath(Jc+" "+f);};l.en="path";g.paintUpdate=function(){this.jsxsuper();if(this.bf!=null){if(this.bf.hasGradient()){var
Db=this;var
uc;while(!(uc=Db.getId()))Db=Db.getParent();var
W="grad_"+uc;if(this.o6!=null&&this.o6.getParent()!=null)this.o6.getParent().removeChild(this.o6);this.setProperty("fill","url(#"+W+")");this.removeProperty("fill-opacity");this.o6=new
xc(Ac.Yh,"linearGradient");this.o6.setId(W);var
hc=this.bf.getAngle()||Number(0);var
M=jsx3.util.numMod(2*Math.PI/360*(-1*hc-90),2*Math.PI);var
zc=Math.cos(M);var
X=Math.sin(M);var
gb=Math.max(Math.abs(zc),Math.abs(X));X=X/gb;zc=zc/gb;this.o6.setProperty("x1",jsx3.util.numRound(0.5-zc/2,1.0E-4),"y1",jsx3.util.numRound(0.5-X/2,1.0E-4),"x2",jsx3.util.numRound(0.5+zc/2,1.0E-4),"y2",jsx3.util.numRound(0.5+X/2,1.0E-4));var
ec=this.getRotation();if(ec)this.o6.setProperty("gradientTransform","rotate("+-ec+")");var
Ab=new
xc(Ac.Yh,"stop");Ab.setProperty("offset","0%","stop-color",this.bf.getColorHtml(),"stop-opacity",this.bf.getAlpha());this.o6.appendChild(Ab);var
R=this.bf.getColors();if(R){var
C=R.split(/\s*,\s*/);for(var
qb=0;qb<C.length;qb++){var
sc=jsx3.util.strTrim(C[qb]).split(/\s+/,2);if(sc.length==2){var
z=parseInt(sc[0]);if(!isNaN(z)){var
oc=new
xc(Ac.Yh,"stop");oc.setProperty("offset",z+"%","stop-color",sc[1]);this.o6.appendChild(oc);}}}}var
Gb=new
xc(Ac.Yh,"stop");Gb.setProperty("offset","100%","stop-color",this.bf.getColor2Html(),"stop-opacity",this.bf.getAlpha2()!=null?this.bf.getAlpha2():1);this.o6.appendChild(Gb);this.getDefs().appendChild(this.o6);}else this.setProperty("fill",this.bf.getColorHtml(),"fill-opacity",this.bf.getAlpha());}else{this.setProperty("fill","none");this.removeProperty("fill-opacity");if(this.o6!=null&&this.o6.getParent()!=null)this.o6.getParent().removeChild(this.o6);}if(this.mp!=null){var
T=this.mp.getWidth();this.setProperty("stroke",this.mp.getColor(),"stroke-width",T||Number(1),"stroke-opacity",this.mp.getAlpha());}else{this.setProperty("stroke","none");this.removeProperty("stroke-width","stroke-opacity");}var
u=[];var
Lc=this.getLeft()||Number(0);var
tc=this.getTop()||Number(0);if(Lc||tc)u.push("translate("+Lc+","+tc+")");var
ec=this.getRotation();if(ec)u.push("rotate("+ec+","+Math.round(this.getWidth()/2)+","+Math.round(this.getHeight()/2)+")");this.setProperty("transform",u.length>0?u.join(" "):null);};g.setFill=function(q){this.bf=q;};g.setStroke=function(f){this.mp=f;};g.getFill=function(){return this.bf;};g.getStroke=function(){return this.mp;};});jsx3.Class.defineClass("jsx3.vector.Line",jsx3.vector.Shape,null,function(k,n){n.init=function(g,j,f,m,e,l){this.jsxsuper("line",g,j);this.pn(f,m,e,l);};n.pn=function(j,q,i,p){this.setX1(j);this.setY1(q);this.setX2(i);this.setY2(p);};n.getX1=function(){return this.getProperty("x1");};n.setX1=function(r){this.setProperty("x1",r);};n.getY1=function(){return this.getProperty("y1");};n.setY1=function(d){this.setProperty("y1",d);};n.getX2=function(){return this.getProperty("x2");};n.setX2=function(h){this.setProperty("x2",h);};n.getY2=function(){return this.getProperty("y2");};n.setY2=function(i){this.setProperty("y2",i);};n.toString=function(){return "<line "+this.getId()+" {"+this.getX1()+","+this.getY1()+"} {"+this.getX2()+","+this.getY2()+"}/>";};});jsx3.Class.defineClass("jsx3.vector.Rectangle",jsx3.vector.Shape,null,function(r,i){i.init=function(p,s,d,a){this.jsxsuper("rect",p,s,d,a);};i.gl=function(p){this.Hp(p.getLeft(),p.getTop(),p.getWidth(),p.getHeight());};i.Hp=function(l,k,m,c){var
xb=Math.max(this.getLeft(),l);var
T=Math.max(this.getTop(),k);var
vc=Math.min(this.getWidth()-(xb-this.getLeft()),l+m-xb);var
Fb=Math.min(this.getHeight()-(T-this.getTop()),k+c-T);this.setDimensions(xb,T,vc,Fb);};i.getWidth=function(){var
Jb=this.getProperty("width");return Jb!=null?parseInt(Jb):null;};i.setWidth=function(e){this.setProperty("width",typeof e=="number"?e+"px":e);};i.getHeight=function(){var
z=this.getProperty("height");return z!=null?parseInt(z):null;};i.setHeight=function(b){this.setProperty("height",typeof b=="number"?b+"px":b);};});jsx3.Class.defineClass("jsx3.vector.Oval",jsx3.vector.Shape,null,function(a,b){b.init=function(p,s,d,k){this.jsxsuper(a.en,p,s,d,k);};a.en="ellipse";b.getLeft=function(){var
N=this.getProperty("cx");return N!=null?parseInt(N):null;};b.setLeft=function(f){this.setProperty("cx",typeof f=="number"?f+"px":f);};b.getTop=function(){var
vc=this.getProperty("cy");return vc!=null?parseInt(vc):null;};b.setTop=function(k){this.setProperty("cy",typeof k=="number"?k+"px":k);};b.getWidth=function(){var
Q=this.getProperty("rx");return Q!=null?2*parseInt(Q):null;};b.setWidth=function(s){this.setProperty("rx",s!=null?parseFloat(s)/2+"px":null);};b.getHeight=function(){var
Jc=this.getProperty("ry");return Jc!=null?2*parseInt(Jc):null;};b.setHeight=function(e){this.setProperty("ry",e!=null?parseFloat(e)/2+"px":null);};b.paintUpdate=function(){this.jsxsuper();this.setProperty("transform","translate("+this.getWidth()/2+","+this.getHeight()/2+")");};});jsx3.Class.defineClass("jsx3.vector.Polygon",jsx3.vector.Shape,null,function(r,o){o.init=function(k,n,q){this.jsxsuper("polyline",k,n);this.lV=null;this.Tq=q;this.ks=q!=null?q.join(" "):null;};o.pn=function(i){this.lV=i;this.Tq=null;this.ks=i!=null?i.join(" "):null;};o.Pg=function(b){this.lV=null;this.Tq=b;this.ks=b!=null?b.join(" "):null;};o.ih=function(q){this.lV=null;this.Tq=null;this.ks=q;};o.paintUpdate=function(){this.jsxsuper();this.setProperty("points",this.ks);};});jsx3.Class.defineClass("jsx3.vector.TextLine",jsx3.vector.Shape,[jsx3.html.FontTag],function(g,b){var
bc=jsx3.html.Tag;var
Ab=jsx3.app.Browser;var
G=jsx3.vector;b.init=function(j,q,i,p,l){this.PD=j;this.m7=q;this.uS=i;this.my=p;var
ec=Math.max(1,Math.max(j,i)-Math.min(j,i));var
sb=Math.max(1,Math.max(q,p)-Math.min(q,p));this.jsxsuper("text",null,null,ec,sb);var
R=0;var
mc=Math.sqrt(Math.pow(i-j,2)+Math.pow(p-q,2));if(q>=p){R=360-Math.round(Math.acos((i-j)/mc)*180/Math.PI);}else R=Math.round(Math.acos((i-j)/mc)*180/Math.PI);this.vJ=R%360;this.l8=new
jsx3.html.Text(l);};b.getText=function(){return this.l8.getText();};b.setText=function(p){this.l8.setText(p);};b.paintUpdate=function(){if(!this.getProperty("fill"))if(this.bf!=null){this.setProperty("fill",this.bf.getColorHtml(),"fill-opacity",this.bf.getAlpha());}else this.removeProperty("fill","fill-opacity");if(this.mp!=null){var
bb=this.mp.getWidth();this.setProperty("stroke",this.mp.getColor(),"stroke-width",bb||Number(1));}else this.removeProperty("stroke","stroke-width");var
kb=this.getFontSize();if(kb==null){var
Y=Ab.getStyleClass("."+this.getClassName());if(Y!=null)kb=Y.fontSize;}this.setProperty("dy",kb?Math.floor(parseInt(kb)/2.5):0);var
sb=this.getTextAlign();if(!sb){var
Y=Ab.getStyleClass("."+this.getClassName());if(Y!=null)sb=Y.textAlign;}var
uc=null,A=null,Fc=null;if(sb=="left"){Fc="start";uc=this.PD;A=this.m7;}else if(sb=="right"){Fc="end";uc=this.uS;A=this.my;}else{Fc="middle";uc=Math.round((this.uS+this.PD)/2);A=Math.round((this.my+this.m7)/2);}this.setProperty("text-anchor",Fc,"x",uc,"y",A);if(this.vJ>0)this.setProperty("transform","rotate("+this.vJ+","+uc+","+A+")");else this.removeProperty("transform");if(this.l8.getParent()==null)this.appendChild(this.l8);};b.getFontFamily=function(){return this.getProperty("font-family");};b.setFontFamily=function(s){this.setProperty("font-family",s);};b.getFontStyle=function(){return this.getProperty("font-style");};b.setFontStyle=function(l){this.setProperty("font-style",l);};b.getFontWeight=function(){return this.getProperty("font-weight");};b.setFontWeight=function(m){this.setProperty("font-weight",m);};b.getTextDecoration=function(){return this.getProperty("text-decoration");};b.setTextDecoration=function(p){this.setProperty("text-decoration",p);};b.getColor=function(){return this.getProperty("fill");};b.setColor=function(a){this.setProperty("fill",a);};b.Qc=function(e){return e instanceof jsx3.html.Text;};});jsx3.Class.defineClass("jsx3.vector.LineGroup",jsx3.vector.Shape,null,function(n,m){m.init=function(p,s,d,a){this.jsxsuper(null,p,s,d,a);};m.bm=function(h,o,g,b){this.dl(h,o).pj(g,b);};m.me=function(o,c,d,l){this.dl(o,c).pj(d,l,true);};m.se=function(){this.setPath("");};});jsx3.Class.defineClass("jsx3.vector.RectangleGroup",jsx3.vector.Shape,null,function(h,r){r.init=function(p,s,d,a){this.jsxsuper(null,p,s,d,a);};r.uo=function(b,o,g,n){this.dl(b,o).pj(g,o).pj(g,n).pj(b,n).Bh();};r.em=function(o,c,q,m){this.dl(o,c).pj(q,0,true).pj(0,m,true).pj(-1*q,0,true).Bh();};r.lp=function(){this.setPath("");};});jsx3.Class.defineInterface("jsx3.chart.PointRenderer",null,function(i,b){var
